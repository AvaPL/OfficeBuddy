...
final case class UpdateGitHubProviderRequest(
    ...
    def companion: com.zitadel.management.v1.management.UpdateGitHubProviderRequest.type = com.zitadel.management.v1.management.UpdateGitHubProviderRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.management.v1.UpdateGitHubProviderRequest])
}

object UpdateGitHubProviderRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.UpdateGitHubProviderRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.UpdateGitHubProviderRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.management.v1.management.UpdateGitHubProviderRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.management.v1.management.UpdateGitHubProviderRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ManagementProto.javaDescriptor.getMessageTypes().get(508)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ManagementProto.scalaDescriptor.messages(508)
  ...
  lazy val defaultInstance = com.zitadel.management.v1.management.UpdateGitHubProviderRequest(
    id = "",
    name = "",
    clientId = "",
    clientSecret = "",
  ...
  implicit class UpdateGitHubProviderRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.management.v1.management.UpdateGitHubProviderRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.management.v1.management.UpdateGitHubProviderRequest](_l) {
  ...
  ): _root_.com.zitadel.management.v1.management.UpdateGitHubProviderRequest = _root_.com.zitadel.management.v1.management.UpdateGitHubProviderRequest(
    id,
    name,
    clientId,
    clientSecret,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.management.v1.UpdateGitHubProviderRequest])
}
