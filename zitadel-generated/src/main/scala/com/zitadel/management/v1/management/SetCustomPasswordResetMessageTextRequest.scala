...
@SerialVersionUID(0L)
final case class SetCustomPasswordResetMessageTextRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[SetCustomPasswordResetMessageTextRequest] {
    @transient
    ...
    def withLanguage(__v: _root_.scala.Predef.String): SetCustomPasswordResetMessageTextRequest = copy(language = __v)
    def withTitle(__v: _root_.scala.Predef.String): SetCustomPasswordResetMessageTextRequest = copy(title = __v)
    def withPreHeader(__v: _root_.scala.Predef.String): SetCustomPasswordResetMessageTextRequest = copy(preHeader = __v)
    def withSubject(__v: _root_.scala.Predef.String): SetCustomPasswordResetMessageTextRequest = copy(subject = __v)
    def withGreeting(__v: _root_.scala.Predef.String): SetCustomPasswordResetMessageTextRequest = copy(greeting = __v)
    def withText(__v: _root_.scala.Predef.String): SetCustomPasswordResetMessageTextRequest = copy(text = __v)
    def withButtonText(__v: _root_.scala.Predef.String): SetCustomPasswordResetMessageTextRequest = copy(buttonText = __v)
    def withFooterText(__v: _root_.scala.Predef.String): SetCustomPasswordResetMessageTextRequest = copy(footerText = __v)
    ...
    def companion: com.zitadel.management.v1.management.SetCustomPasswordResetMessageTextRequest.type = com.zitadel.management.v1.management.SetCustomPasswordResetMessageTextRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.management.v1.SetCustomPasswordResetMessageTextRequest])
}

object SetCustomPasswordResetMessageTextRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.SetCustomPasswordResetMessageTextRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.SetCustomPasswordResetMessageTextRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.management.v1.management.SetCustomPasswordResetMessageTextRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.management.v1.management.SetCustomPasswordResetMessageTextRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ManagementProto.javaDescriptor.getMessageTypes().get(418)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ManagementProto.scalaDescriptor.messages(418)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = com.zitadel.management.v1.management.SetCustomPasswordResetMessageTextRequest(
    language = "",
    title = "",
    preHeader = "",
    subject = "",
  ...
  implicit class SetCustomPasswordResetMessageTextRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.management.v1.management.SetCustomPasswordResetMessageTextRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.management.v1.management.SetCustomPasswordResetMessageTextRequest](_l) {
  ...
  def of(
    ...
    buttonText: _root_.scala.Predef.String,
    footerText: _root_.scala.Predef.String
  ): _root_.com.zitadel.management.v1.management.SetCustomPasswordResetMessageTextRequest = _root_.com.zitadel.management.v1.management.SetCustomPasswordResetMessageTextRequest(
    language,
    title,
    preHeader,
    subject,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.management.v1.SetCustomPasswordResetMessageTextRequest])
}
