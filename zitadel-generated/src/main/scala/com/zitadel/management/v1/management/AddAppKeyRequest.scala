...
@SerialVersionUID(0L)
final case class AddAppKeyRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[AddAppKeyRequest] {
    @transient
    ...
    def withProjectId(__v: _root_.scala.Predef.String): AddAppKeyRequest = copy(projectId = __v)
    def withAppId(__v: _root_.scala.Predef.String): AddAppKeyRequest = copy(appId = __v)
    def withType(__v: com.zitadel.authn.v1.auth_n_key.KeyType): AddAppKeyRequest = copy(`type` = __v)
    ...
    def clearExpirationDate: AddAppKeyRequest = copy(expirationDate = _root_.scala.None)
    def withExpirationDate(__v: com.google.protobuf.timestamp.Timestamp): AddAppKeyRequest = copy(expirationDate = Option(__v))
    ...
    def companion: com.zitadel.management.v1.management.AddAppKeyRequest.type = com.zitadel.management.v1.management.AddAppKeyRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.management.v1.AddAppKeyRequest])
}

object AddAppKeyRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.AddAppKeyRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.AddAppKeyRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.management.v1.management.AddAppKeyRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.management.v1.management.AddAppKeyRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ManagementProto.javaDescriptor.getMessageTypes().get(244)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ManagementProto.scalaDescriptor.messages(244)
  ...
  lazy val defaultInstance = com.zitadel.management.v1.management.AddAppKeyRequest(
    projectId = "",
    appId = "",
    `type` = com.zitadel.authn.v1.auth_n_key.KeyType.KEY_TYPE_UNSPECIFIED,
    expirationDate = _root_.scala.None
  )
  implicit class AddAppKeyRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.management.v1.management.AddAppKeyRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.management.v1.management.AddAppKeyRequest](_l) {
  ...
  ): _root_.com.zitadel.management.v1.management.AddAppKeyRequest = _root_.com.zitadel.management.v1.management.AddAppKeyRequest(
    projectId,
    appId,
    `type`,
    expirationDate
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.management.v1.AddAppKeyRequest])
}
