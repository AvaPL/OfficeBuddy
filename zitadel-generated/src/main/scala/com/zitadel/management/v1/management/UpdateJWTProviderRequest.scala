...
final case class UpdateJWTProviderRequest(
    ...
    def companion: com.zitadel.management.v1.management.UpdateJWTProviderRequest.type = com.zitadel.management.v1.management.UpdateJWTProviderRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.management.v1.UpdateJWTProviderRequest])
}

object UpdateJWTProviderRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.UpdateJWTProviderRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.UpdateJWTProviderRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.management.v1.management.UpdateJWTProviderRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.management.v1.management.UpdateJWTProviderRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ManagementProto.javaDescriptor.getMessageTypes().get(500)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ManagementProto.scalaDescriptor.messages(500)
  ...
  lazy val defaultInstance = com.zitadel.management.v1.management.UpdateJWTProviderRequest(
    id = "",
    name = "",
    issuer = "",
    jwtEndpoint = "",
  ...
  implicit class UpdateJWTProviderRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.management.v1.management.UpdateJWTProviderRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.management.v1.management.UpdateJWTProviderRequest](_l) {
  ...
  ): _root_.com.zitadel.management.v1.management.UpdateJWTProviderRequest = _root_.com.zitadel.management.v1.management.UpdateJWTProviderRequest(
    id,
    name,
    issuer,
    jwtEndpoint,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.management.v1.UpdateJWTProviderRequest])
}
