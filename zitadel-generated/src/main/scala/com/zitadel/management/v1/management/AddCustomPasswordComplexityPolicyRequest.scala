...
@SerialVersionUID(0L)
final case class AddCustomPasswordComplexityPolicyRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[AddCustomPasswordComplexityPolicyRequest] {
    @transient
    ...
    def withMinLength(__v: _root_.scala.Long): AddCustomPasswordComplexityPolicyRequest = copy(minLength = __v)
    def withHasUppercase(__v: _root_.scala.Boolean): AddCustomPasswordComplexityPolicyRequest = copy(hasUppercase = __v)
    def withHasLowercase(__v: _root_.scala.Boolean): AddCustomPasswordComplexityPolicyRequest = copy(hasLowercase = __v)
    def withHasNumber(__v: _root_.scala.Boolean): AddCustomPasswordComplexityPolicyRequest = copy(hasNumber = __v)
    def withHasSymbol(__v: _root_.scala.Boolean): AddCustomPasswordComplexityPolicyRequest = copy(hasSymbol = __v)
    ...
    def companion: com.zitadel.management.v1.management.AddCustomPasswordComplexityPolicyRequest.type = com.zitadel.management.v1.management.AddCustomPasswordComplexityPolicyRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.management.v1.AddCustomPasswordComplexityPolicyRequest])
}

object AddCustomPasswordComplexityPolicyRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.AddCustomPasswordComplexityPolicyRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.AddCustomPasswordComplexityPolicyRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.management.v1.management.AddCustomPasswordComplexityPolicyRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.management.v1.management.AddCustomPasswordComplexityPolicyRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ManagementProto.javaDescriptor.getMessageTypes().get(328)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ManagementProto.scalaDescriptor.messages(328)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = com.zitadel.management.v1.management.AddCustomPasswordComplexityPolicyRequest(
    minLength = 0L,
    hasUppercase = false,
    hasLowercase = false,
    hasNumber = false,
  ...
  implicit class AddCustomPasswordComplexityPolicyRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.management.v1.management.AddCustomPasswordComplexityPolicyRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.management.v1.management.AddCustomPasswordComplexityPolicyRequest](_l) {
  ...
  ): _root_.com.zitadel.management.v1.management.AddCustomPasswordComplexityPolicyRequest = _root_.com.zitadel.management.v1.management.AddCustomPasswordComplexityPolicyRequest(
    minLength,
    hasUppercase,
    hasLowercase,
    hasNumber,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.management.v1.AddCustomPasswordComplexityPolicyRequest])
}
