...
@SerialVersionUID(0L)
final case class UpdateOrgIDPOIDCConfigRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[UpdateOrgIDPOIDCConfigRequest] {
    @transient
    ...
    def withIdpId(__v: _root_.scala.Predef.String): UpdateOrgIDPOIDCConfigRequest = copy(idpId = __v)
    def withClientId(__v: _root_.scala.Predef.String): UpdateOrgIDPOIDCConfigRequest = copy(clientId = __v)
    def withClientSecret(__v: _root_.scala.Predef.String): UpdateOrgIDPOIDCConfigRequest = copy(clientSecret = __v)
    def withIssuer(__v: _root_.scala.Predef.String): UpdateOrgIDPOIDCConfigRequest = copy(issuer = __v)
    def clearScopes = copy(scopes = _root_.scala.Seq.empty)
    def addScopes(__vs: _root_.scala.Predef.String *): UpdateOrgIDPOIDCConfigRequest = addAllScopes(__vs)
    def addAllScopes(__vs: Iterable[_root_.scala.Predef.String]): UpdateOrgIDPOIDCConfigRequest = copy(scopes = scopes ++ __vs)
    def withScopes(__v: _root_.scala.Seq[_root_.scala.Predef.String]): UpdateOrgIDPOIDCConfigRequest = copy(scopes = __v)
    def withDisplayNameMapping(__v: com.zitadel.idp.v1.idp.OIDCMappingField): UpdateOrgIDPOIDCConfigRequest = copy(displayNameMapping = __v)
    def withUsernameMapping(__v: com.zitadel.idp.v1.idp.OIDCMappingField): UpdateOrgIDPOIDCConfigRequest = copy(usernameMapping = __v)
    ...
    def companion: com.zitadel.management.v1.management.UpdateOrgIDPOIDCConfigRequest.type = com.zitadel.management.v1.management.UpdateOrgIDPOIDCConfigRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.management.v1.UpdateOrgIDPOIDCConfigRequest])
}

object UpdateOrgIDPOIDCConfigRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.UpdateOrgIDPOIDCConfigRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.UpdateOrgIDPOIDCConfigRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.management.v1.management.UpdateOrgIDPOIDCConfigRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.management.v1.management.UpdateOrgIDPOIDCConfigRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ManagementProto.javaDescriptor.getMessageTypes().get(479)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ManagementProto.scalaDescriptor.messages(479)
  ...
  lazy val defaultInstance = com.zitadel.management.v1.management.UpdateOrgIDPOIDCConfigRequest(
    idpId = "",
    clientId = "",
    clientSecret = "",
    issuer = "",
  ...
  implicit class UpdateOrgIDPOIDCConfigRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.management.v1.management.UpdateOrgIDPOIDCConfigRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.management.v1.management.UpdateOrgIDPOIDCConfigRequest](_l) {
  ...
  ): _root_.com.zitadel.management.v1.management.UpdateOrgIDPOIDCConfigRequest = _root_.com.zitadel.management.v1.management.UpdateOrgIDPOIDCConfigRequest(
    idpId,
    clientId,
    clientSecret,
    issuer,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.management.v1.UpdateOrgIDPOIDCConfigRequest])
}
