...
/** @param hideLoginNameSuffix
  ...
  */
@SerialVersionUID(0L)
final case class AddCustomLabelPolicyRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[AddCustomLabelPolicyRequest] {
    @transient
    ...
    def withPrimaryColor(__v: _root_.scala.Predef.String): AddCustomLabelPolicyRequest = copy(primaryColor = __v)
    def withHideLoginNameSuffix(__v: _root_.scala.Boolean): AddCustomLabelPolicyRequest = copy(hideLoginNameSuffix = __v)
    def withWarnColor(__v: _root_.scala.Predef.String): AddCustomLabelPolicyRequest = copy(warnColor = __v)
    def withBackgroundColor(__v: _root_.scala.Predef.String): AddCustomLabelPolicyRequest = copy(backgroundColor = __v)
    def withFontColor(__v: _root_.scala.Predef.String): AddCustomLabelPolicyRequest = copy(fontColor = __v)
    def withPrimaryColorDark(__v: _root_.scala.Predef.String): AddCustomLabelPolicyRequest = copy(primaryColorDark = __v)
    def withBackgroundColorDark(__v: _root_.scala.Predef.String): AddCustomLabelPolicyRequest = copy(backgroundColorDark = __v)
    def withWarnColorDark(__v: _root_.scala.Predef.String): AddCustomLabelPolicyRequest = copy(warnColorDark = __v)
    def withFontColorDark(__v: _root_.scala.Predef.String): AddCustomLabelPolicyRequest = copy(fontColorDark = __v)
    def withDisableWatermark(__v: _root_.scala.Boolean): AddCustomLabelPolicyRequest = copy(disableWatermark = __v)
    ...
    def companion: com.zitadel.management.v1.management.AddCustomLabelPolicyRequest.type = com.zitadel.management.v1.management.AddCustomLabelPolicyRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.management.v1.AddCustomLabelPolicyRequest])
}

object AddCustomLabelPolicyRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.AddCustomLabelPolicyRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.AddCustomLabelPolicyRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.management.v1.management.AddCustomLabelPolicyRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.management.v1.management.AddCustomLabelPolicyRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ManagementProto.javaDescriptor.getMessageTypes().get(380)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ManagementProto.scalaDescriptor.messages(380)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = com.zitadel.management.v1.management.AddCustomLabelPolicyRequest(
    primaryColor = "",
  ...
  implicit class AddCustomLabelPolicyRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.management.v1.management.AddCustomLabelPolicyRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.management.v1.management.AddCustomLabelPolicyRequest](_l) {
  ...
  ): _root_.com.zitadel.management.v1.management.AddCustomLabelPolicyRequest = _root_.com.zitadel.management.v1.management.AddCustomLabelPolicyRequest(
    primaryColor,
    hideLoginNameSuffix,
    warnColor,
    backgroundColor,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.management.v1.AddCustomLabelPolicyRequest])
}
