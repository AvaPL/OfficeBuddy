...
@SerialVersionUID(0L)
final case class AddOrgJWTIDPRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[AddOrgJWTIDPRequest] {
    @transient
    ...
    def withName(__v: _root_.scala.Predef.String): AddOrgJWTIDPRequest = copy(name = __v)
    def withStylingType(__v: com.zitadel.idp.v1.idp.IDPStylingType): AddOrgJWTIDPRequest = copy(stylingType = __v)
    def withJwtEndpoint(__v: _root_.scala.Predef.String): AddOrgJWTIDPRequest = copy(jwtEndpoint = __v)
    def withIssuer(__v: _root_.scala.Predef.String): AddOrgJWTIDPRequest = copy(issuer = __v)
    def withKeysEndpoint(__v: _root_.scala.Predef.String): AddOrgJWTIDPRequest = copy(keysEndpoint = __v)
    def withHeaderName(__v: _root_.scala.Predef.String): AddOrgJWTIDPRequest = copy(headerName = __v)
    def withAutoRegister(__v: _root_.scala.Boolean): AddOrgJWTIDPRequest = copy(autoRegister = __v)
    ...
    def companion: com.zitadel.management.v1.management.AddOrgJWTIDPRequest.type = com.zitadel.management.v1.management.AddOrgJWTIDPRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.management.v1.AddOrgJWTIDPRequest])
}

object AddOrgJWTIDPRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.AddOrgJWTIDPRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.AddOrgJWTIDPRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.management.v1.management.AddOrgJWTIDPRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.management.v1.management.AddOrgJWTIDPRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ManagementProto.javaDescriptor.getMessageTypes().get(469)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ManagementProto.scalaDescriptor.messages(469)
  ...
  lazy val defaultInstance = com.zitadel.management.v1.management.AddOrgJWTIDPRequest(
    name = "",
  ...
  implicit class AddOrgJWTIDPRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.management.v1.management.AddOrgJWTIDPRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.management.v1.management.AddOrgJWTIDPRequest](_l) {
  ...
  ): _root_.com.zitadel.management.v1.management.AddOrgJWTIDPRequest = _root_.com.zitadel.management.v1.management.AddOrgJWTIDPRequest(
    name,
    stylingType,
    jwtEndpoint,
    issuer,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.management.v1.AddOrgJWTIDPRequest])
}
