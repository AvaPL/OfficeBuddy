...
final case class View(
    ...
    instance: _root_.scala.Predef.String = "",
    ...
    def withInstance(__v: _root_.scala.Predef.String): View = copy(instance = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 6 => _root_.scalapb.descriptors.PString(instance)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion: com.zitadel.system.v1.system.View.type = com.zitadel.system.v1.system.View
    // @@protoc_insertion_point(GeneratedMessage[zitadel.system.v1.View])
}

object View extends scalapb.GeneratedMessageCompanion[com.zitadel.system.v1.system.View] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.system.v1.system.View] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.system.v1.system.View = {
    ...
    var __instance: _root_.scala.Predef.String = ""
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 50 =>
          __instance = _input__.readStringRequireUtf8()
        case tag =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.system.v1.system.View] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      com.zitadel.system.v1.system.View(
        ...
        instance = __fieldsMap.get(scalaDescriptor.findFieldByNumber(6).get).map(_.as[_root_.scala.Predef.String]).getOrElse("")
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = SystemProto.javaDescriptor.getMessageTypes().get(41)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = SystemProto.scalaDescriptor.messages(41)
  ...
  lazy val defaultInstance = com.zitadel.system.v1.system.View(
    database = "",
    viewName = "",
  ...
  implicit class ViewLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.system.v1.system.View]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.system.v1.system.View](_l) {
    ...
    def instance: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Predef.String] = field(_.instance)((c_, f_) => c_.copy(instance = f_))
  }
  ...
  def of(
    ...
    instance: _root_.scala.Predef.String
  ): _root_.com.zitadel.system.v1.system.View = _root_.com.zitadel.system.v1.system.View(
    database,
    viewName,
    processedSequence,
    eventTimestamp,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.system.v1.View])
}
