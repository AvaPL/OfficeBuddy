...
@SerialVersionUID(0L)
final case class AddMyPasswordlessLinkResponse(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[AddMyPasswordlessLinkResponse] {
    @transient
    ...
    def clearDetails: AddMyPasswordlessLinkResponse = copy(details = _root_.scala.None)
    def withDetails(__v: com.zitadel.v1.`object`.ObjectDetails): AddMyPasswordlessLinkResponse = copy(details = Option(__v))
    def withLink(__v: _root_.scala.Predef.String): AddMyPasswordlessLinkResponse = copy(link = __v)
    ...
    def clearExpiration: AddMyPasswordlessLinkResponse = copy(expiration = _root_.scala.None)
    def withExpiration(__v: com.google.protobuf.duration.Duration): AddMyPasswordlessLinkResponse = copy(expiration = Option(__v))
    ...
    def companion: com.zitadel.auth.v1.auth.AddMyPasswordlessLinkResponse.type = com.zitadel.auth.v1.auth.AddMyPasswordlessLinkResponse
    // @@protoc_insertion_point(GeneratedMessage[zitadel.auth.v1.AddMyPasswordlessLinkResponse])
}

object AddMyPasswordlessLinkResponse extends scalapb.GeneratedMessageCompanion[com.zitadel.auth.v1.auth.AddMyPasswordlessLinkResponse] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.auth.v1.auth.AddMyPasswordlessLinkResponse] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.auth.v1.auth.AddMyPasswordlessLinkResponse = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.auth.v1.auth.AddMyPasswordlessLinkResponse] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = AuthProto.javaDescriptor.getMessageTypes().get(83)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = AuthProto.scalaDescriptor.messages(83)
  ...
  lazy val defaultInstance = com.zitadel.auth.v1.auth.AddMyPasswordlessLinkResponse(
    details = _root_.scala.None,
    link = "",
    expiration = _root_.scala.None
  )
  implicit class AddMyPasswordlessLinkResponseLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.auth.v1.auth.AddMyPasswordlessLinkResponse]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.auth.v1.auth.AddMyPasswordlessLinkResponse](_l) {
  ...
  ): _root_.com.zitadel.auth.v1.auth.AddMyPasswordlessLinkResponse = _root_.com.zitadel.auth.v1.auth.AddMyPasswordlessLinkResponse(
    details,
    link,
    expiration
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.auth.v1.AddMyPasswordlessLinkResponse])
}
