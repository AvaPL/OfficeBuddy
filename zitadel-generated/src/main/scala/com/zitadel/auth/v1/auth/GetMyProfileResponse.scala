...
@SerialVersionUID(0L)
final case class GetMyProfileResponse(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[GetMyProfileResponse] {
    @transient
    ...
    def clearDetails: GetMyProfileResponse = copy(details = _root_.scala.None)
    def withDetails(__v: com.zitadel.v1.`object`.ObjectDetails): GetMyProfileResponse = copy(details = Option(__v))
    def getProfile: com.zitadel.user.v1.user.Profile = profile.getOrElse(com.zitadel.user.v1.user.Profile.defaultInstance)
    def clearProfile: GetMyProfileResponse = copy(profile = _root_.scala.None)
    def withProfile(__v: com.zitadel.user.v1.user.Profile): GetMyProfileResponse = copy(profile = Option(__v))
    ...
    def companion: com.zitadel.auth.v1.auth.GetMyProfileResponse.type = com.zitadel.auth.v1.auth.GetMyProfileResponse
    // @@protoc_insertion_point(GeneratedMessage[zitadel.auth.v1.GetMyProfileResponse])
}

object GetMyProfileResponse extends scalapb.GeneratedMessageCompanion[com.zitadel.auth.v1.auth.GetMyProfileResponse] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.auth.v1.auth.GetMyProfileResponse] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.auth.v1.auth.GetMyProfileResponse = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.auth.v1.auth.GetMyProfileResponse] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = AuthProto.javaDescriptor.getMessageTypes().get(37)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = AuthProto.scalaDescriptor.messages(37)
  ...
  lazy val defaultInstance = com.zitadel.auth.v1.auth.GetMyProfileResponse(
    details = _root_.scala.None,
    profile = _root_.scala.None
  )
  implicit class GetMyProfileResponseLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.auth.v1.auth.GetMyProfileResponse]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.auth.v1.auth.GetMyProfileResponse](_l) {
  ...
  ): _root_.com.zitadel.auth.v1.auth.GetMyProfileResponse = _root_.com.zitadel.auth.v1.auth.GetMyProfileResponse(
    details,
    profile
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.auth.v1.GetMyProfileResponse])
}
