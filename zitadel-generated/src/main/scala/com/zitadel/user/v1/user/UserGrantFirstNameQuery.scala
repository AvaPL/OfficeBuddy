...
@SerialVersionUID(0L)
final case class UserGrantFirstNameQuery(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[UserGrantFirstNameQuery] {
    @transient
    ...
    def withFirstName(__v: _root_.scala.Predef.String): UserGrantFirstNameQuery = copy(firstName = __v)
    def withMethod(__v: com.zitadel.v1.`object`.TextQueryMethod): UserGrantFirstNameQuery = copy(method = __v)
    ...
    def companion: com.zitadel.user.v1.user.UserGrantFirstNameQuery.type = com.zitadel.user.v1.user.UserGrantFirstNameQuery
    // @@protoc_insertion_point(GeneratedMessage[zitadel.user.v1.UserGrantFirstNameQuery])
}

object UserGrantFirstNameQuery extends scalapb.GeneratedMessageCompanion[com.zitadel.user.v1.user.UserGrantFirstNameQuery] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.user.v1.user.UserGrantFirstNameQuery] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.user.v1.user.UserGrantFirstNameQuery = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.user.v1.user.UserGrantFirstNameQuery] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = com.zitadel.user.v1.user.UserGrantFirstNameQuery(
    firstName = "",
    method = com.zitadel.v1.`object`.TextQueryMethod.TEXT_QUERY_METHOD_EQUALS
  )
  implicit class UserGrantFirstNameQueryLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.user.v1.user.UserGrantFirstNameQuery]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.user.v1.user.UserGrantFirstNameQuery](_l) {
  ...
  ): _root_.com.zitadel.user.v1.user.UserGrantFirstNameQuery = _root_.com.zitadel.user.v1.user.UserGrantFirstNameQuery(
    firstName,
    method
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.user.v1.UserGrantFirstNameQuery])
}
