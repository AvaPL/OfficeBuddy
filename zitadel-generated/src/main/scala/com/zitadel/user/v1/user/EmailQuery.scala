...
final case class EmailQuery(
    ...
    def withEmailAddress(__v: _root_.scala.Predef.String): EmailQuery = copy(emailAddress = __v)
    ...
    def companion: com.zitadel.user.v1.user.EmailQuery.type = com.zitadel.user.v1.user.EmailQuery
    // @@protoc_insertion_point(GeneratedMessage[zitadel.user.v1.EmailQuery])
}

object EmailQuery extends scalapb.GeneratedMessageCompanion[com.zitadel.user.v1.user.EmailQuery] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.user.v1.user.EmailQuery] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.user.v1.user.EmailQuery = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.user.v1.user.EmailQuery] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = com.zitadel.user.v1.user.EmailQuery(
    emailAddress = "",
    method = com.zitadel.v1.`object`.TextQueryMethod.TEXT_QUERY_METHOD_EQUALS
  )
  implicit class EmailQueryLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.user.v1.user.EmailQuery]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.user.v1.user.EmailQuery](_l) {
  ...
  ): _root_.com.zitadel.user.v1.user.EmailQuery = _root_.com.zitadel.user.v1.user.EmailQuery(
    emailAddress,
    method
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.user.v1.EmailQuery])
}
