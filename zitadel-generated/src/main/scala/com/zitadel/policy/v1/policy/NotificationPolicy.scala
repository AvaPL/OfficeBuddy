...
@SerialVersionUID(0L)
final case class NotificationPolicy(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[NotificationPolicy] {
    @transient
    ...
    def clearDetails: NotificationPolicy = copy(details = _root_.scala.None)
    def withDetails(__v: com.zitadel.v1.`object`.ObjectDetails): NotificationPolicy = copy(details = Option(__v))
    def withIsDefault(__v: _root_.scala.Boolean): NotificationPolicy = copy(isDefault = __v)
    def withPasswordChange(__v: _root_.scala.Boolean): NotificationPolicy = copy(passwordChange = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 3 => _root_.scalapb.descriptors.PBoolean(passwordChange)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion: com.zitadel.policy.v1.policy.NotificationPolicy.type = com.zitadel.policy.v1.policy.NotificationPolicy
    // @@protoc_insertion_point(GeneratedMessage[zitadel.policy.v1.NotificationPolicy])
}

object NotificationPolicy extends scalapb.GeneratedMessageCompanion[com.zitadel.policy.v1.policy.NotificationPolicy] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.policy.v1.policy.NotificationPolicy] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.policy.v1.policy.NotificationPolicy = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.policy.v1.policy.NotificationPolicy] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      com.zitadel.policy.v1.policy.NotificationPolicy(
        ...
        passwordChange = __fieldsMap.get(scalaDescriptor.findFieldByNumber(3).get).map(_.as[_root_.scala.Boolean]).getOrElse(false)
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = PolicyProto.javaDescriptor.getMessageTypes().get(8)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = PolicyProto.scalaDescriptor.messages(8)
  ...
  lazy val defaultInstance = com.zitadel.policy.v1.policy.NotificationPolicy(
    details = _root_.scala.None,
    isDefault = false,
    passwordChange = false
  )
  implicit class NotificationPolicyLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.policy.v1.policy.NotificationPolicy]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.policy.v1.policy.NotificationPolicy](_l) {
  ...
  final val PASSWORD_CHANGE_FIELD_NUMBER = 3
  def of(
  ...
  ): _root_.com.zitadel.policy.v1.policy.NotificationPolicy = _root_.com.zitadel.policy.v1.policy.NotificationPolicy(
    details,
    isDefault,
    passwordChange
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.policy.v1.NotificationPolicy])
}
