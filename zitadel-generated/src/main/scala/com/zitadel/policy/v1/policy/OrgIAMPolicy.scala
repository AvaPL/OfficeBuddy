...
final case class OrgIAMPolicy(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[OrgIAMPolicy] {
    @transient
    ...
    def clearDetails: OrgIAMPolicy = copy(details = _root_.scala.None)
    def withDetails(__v: com.zitadel.v1.`object`.ObjectDetails): OrgIAMPolicy = copy(details = Option(__v))
    def withUserLoginMustBeDomain(__v: _root_.scala.Boolean): OrgIAMPolicy = copy(userLoginMustBeDomain = __v)
    def withIsDefault(__v: _root_.scala.Boolean): OrgIAMPolicy = copy(isDefault = __v)
    ...
    def companion: com.zitadel.policy.v1.policy.OrgIAMPolicy.type = com.zitadel.policy.v1.policy.OrgIAMPolicy
    // @@protoc_insertion_point(GeneratedMessage[zitadel.policy.v1.OrgIAMPolicy])
}

object OrgIAMPolicy extends scalapb.GeneratedMessageCompanion[com.zitadel.policy.v1.policy.OrgIAMPolicy] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.policy.v1.policy.OrgIAMPolicy] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.policy.v1.policy.OrgIAMPolicy = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.policy.v1.policy.OrgIAMPolicy] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = com.zitadel.policy.v1.policy.OrgIAMPolicy(
    details = _root_.scala.None,
    userLoginMustBeDomain = false,
    isDefault = false
  )
  implicit class OrgIAMPolicyLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.policy.v1.policy.OrgIAMPolicy]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.policy.v1.policy.OrgIAMPolicy](_l) {
  ...
  ): _root_.com.zitadel.policy.v1.policy.OrgIAMPolicy = _root_.com.zitadel.policy.v1.policy.OrgIAMPolicy(
    details,
    userLoginMustBeDomain,
    isDefault
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.policy.v1.OrgIAMPolicy])
}
