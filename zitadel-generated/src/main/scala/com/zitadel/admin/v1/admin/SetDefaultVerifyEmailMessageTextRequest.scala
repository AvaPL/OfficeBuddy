...
@SerialVersionUID(0L)
final case class SetDefaultVerifyEmailMessageTextRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[SetDefaultVerifyEmailMessageTextRequest] {
    @transient
    ...
    def withLanguage(__v: _root_.scala.Predef.String): SetDefaultVerifyEmailMessageTextRequest = copy(language = __v)
    def withTitle(__v: _root_.scala.Predef.String): SetDefaultVerifyEmailMessageTextRequest = copy(title = __v)
    def withPreHeader(__v: _root_.scala.Predef.String): SetDefaultVerifyEmailMessageTextRequest = copy(preHeader = __v)
    def withSubject(__v: _root_.scala.Predef.String): SetDefaultVerifyEmailMessageTextRequest = copy(subject = __v)
    def withGreeting(__v: _root_.scala.Predef.String): SetDefaultVerifyEmailMessageTextRequest = copy(greeting = __v)
    def withText(__v: _root_.scala.Predef.String): SetDefaultVerifyEmailMessageTextRequest = copy(text = __v)
    def withButtonText(__v: _root_.scala.Predef.String): SetDefaultVerifyEmailMessageTextRequest = copy(buttonText = __v)
    def withFooterText(__v: _root_.scala.Predef.String): SetDefaultVerifyEmailMessageTextRequest = copy(footerText = __v)
    ...
    def companion: com.zitadel.admin.v1.admin.SetDefaultVerifyEmailMessageTextRequest.type = com.zitadel.admin.v1.admin.SetDefaultVerifyEmailMessageTextRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.admin.v1.SetDefaultVerifyEmailMessageTextRequest])
}

object SetDefaultVerifyEmailMessageTextRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.SetDefaultVerifyEmailMessageTextRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.SetDefaultVerifyEmailMessageTextRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.admin.v1.admin.SetDefaultVerifyEmailMessageTextRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.admin.v1.admin.SetDefaultVerifyEmailMessageTextRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = AdminProto.javaDescriptor.getMessageTypes().get(248)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = AdminProto.scalaDescriptor.messages(248)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = com.zitadel.admin.v1.admin.SetDefaultVerifyEmailMessageTextRequest(
    language = "",
    title = "",
    preHeader = "",
    subject = "",
  ...
  implicit class SetDefaultVerifyEmailMessageTextRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.admin.v1.admin.SetDefaultVerifyEmailMessageTextRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.admin.v1.admin.SetDefaultVerifyEmailMessageTextRequest](_l) {
  ...
  def of(
    ...
    buttonText: _root_.scala.Predef.String,
    footerText: _root_.scala.Predef.String
  ): _root_.com.zitadel.admin.v1.admin.SetDefaultVerifyEmailMessageTextRequest = _root_.com.zitadel.admin.v1.admin.SetDefaultVerifyEmailMessageTextRequest(
    language,
    title,
    preHeader,
    subject,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.admin.v1.SetDefaultVerifyEmailMessageTextRequest])
}
