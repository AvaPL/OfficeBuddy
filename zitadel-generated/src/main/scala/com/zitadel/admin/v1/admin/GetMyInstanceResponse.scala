...
@SerialVersionUID(0L)
final case class GetMyInstanceResponse(
    instance: _root_.scala.Option[com.zitadel.instance.v1.instance.InstanceDetail] = _root_.scala.None,
    unknownFields: _root_.scalapb.UnknownFieldSet = _root_.scalapb.UnknownFieldSet.empty
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[GetMyInstanceResponse] {
    @transient
    ...
    def clearInstance: GetMyInstanceResponse = copy(instance = _root_.scala.None)
    def withInstance(__v: com.zitadel.instance.v1.instance.InstanceDetail): GetMyInstanceResponse = copy(instance = Option(__v))
    ...
    def companion: com.zitadel.admin.v1.admin.GetMyInstanceResponse.type = com.zitadel.admin.v1.admin.GetMyInstanceResponse
    // @@protoc_insertion_point(GeneratedMessage[zitadel.admin.v1.GetMyInstanceResponse])
}

object GetMyInstanceResponse extends scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.GetMyInstanceResponse] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.GetMyInstanceResponse] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.admin.v1.admin.GetMyInstanceResponse = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.admin.v1.admin.GetMyInstanceResponse] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = com.zitadel.admin.v1.admin.GetMyInstanceResponse(
    instance = _root_.scala.None
  )
  implicit class GetMyInstanceResponseLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.admin.v1.admin.GetMyInstanceResponse]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.admin.v1.admin.GetMyInstanceResponse](_l) {
  ...
  ): _root_.com.zitadel.admin.v1.admin.GetMyInstanceResponse = _root_.com.zitadel.admin.v1.admin.GetMyInstanceResponse(
    instance
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.admin.v1.GetMyInstanceResponse])
}
