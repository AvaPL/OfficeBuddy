...
final case class AddGenericOAuthProviderRequest(
    ...
    def companion: com.zitadel.admin.v1.admin.AddGenericOAuthProviderRequest.type = com.zitadel.admin.v1.admin.AddGenericOAuthProviderRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.admin.v1.AddGenericOAuthProviderRequest])
}

object AddGenericOAuthProviderRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.AddGenericOAuthProviderRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.AddGenericOAuthProviderRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.admin.v1.admin.AddGenericOAuthProviderRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.admin.v1.admin.AddGenericOAuthProviderRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = AdminProto.javaDescriptor.getMessageTypes().get(98)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = AdminProto.scalaDescriptor.messages(98)
  ...
  lazy val defaultInstance = com.zitadel.admin.v1.admin.AddGenericOAuthProviderRequest(
    name = "",
    clientId = "",
    clientSecret = "",
  ...
  implicit class AddGenericOAuthProviderRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.admin.v1.admin.AddGenericOAuthProviderRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.admin.v1.admin.AddGenericOAuthProviderRequest](_l) {
  ...
  ): _root_.com.zitadel.admin.v1.admin.AddGenericOAuthProviderRequest = _root_.com.zitadel.admin.v1.admin.AddGenericOAuthProviderRequest(
    name,
    clientId,
    clientSecret,
    authorizationEndpoint,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.admin.v1.AddGenericOAuthProviderRequest])
}
