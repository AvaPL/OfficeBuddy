...
/** @param clientSecret
  ...
  */
@SerialVersionUID(0L)
final case class UpdateGoogleProviderRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[UpdateGoogleProviderRequest] {
    @transient
    ...
    def withId(__v: _root_.scala.Predef.String): UpdateGoogleProviderRequest = copy(id = __v)
    def withName(__v: _root_.scala.Predef.String): UpdateGoogleProviderRequest = copy(name = __v)
    def withClientId(__v: _root_.scala.Predef.String): UpdateGoogleProviderRequest = copy(clientId = __v)
    def withClientSecret(__v: _root_.scala.Predef.String): UpdateGoogleProviderRequest = copy(clientSecret = __v)
    def clearScopes = copy(scopes = _root_.scala.Seq.empty)
    def addScopes(__vs: _root_.scala.Predef.String *): UpdateGoogleProviderRequest = addAllScopes(__vs)
    def addAllScopes(__vs: Iterable[_root_.scala.Predef.String]): UpdateGoogleProviderRequest = copy(scopes = scopes ++ __vs)
    def withScopes(__v: _root_.scala.Seq[_root_.scala.Predef.String]): UpdateGoogleProviderRequest = copy(scopes = __v)
    ...
    def clearProviderOptions: UpdateGoogleProviderRequest = copy(providerOptions = _root_.scala.None)
    def withProviderOptions(__v: com.zitadel.idp.v1.idp.Options): UpdateGoogleProviderRequest = copy(providerOptions = Option(__v))
    ...
    def companion: com.zitadel.management.v1.management.UpdateGoogleProviderRequest.type = com.zitadel.management.v1.management.UpdateGoogleProviderRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.management.v1.UpdateGoogleProviderRequest])
}

object UpdateGoogleProviderRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.UpdateGoogleProviderRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.UpdateGoogleProviderRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.management.v1.management.UpdateGoogleProviderRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.management.v1.management.UpdateGoogleProviderRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ManagementProto.javaDescriptor.getMessageTypes().get(524)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ManagementProto.scalaDescriptor.messages(524)
  ...
  lazy val defaultInstance = com.zitadel.management.v1.management.UpdateGoogleProviderRequest(
    id = "",
    name = "",
    clientId = "",
    clientSecret = "",
  ...
  implicit class UpdateGoogleProviderRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.management.v1.management.UpdateGoogleProviderRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.management.v1.management.UpdateGoogleProviderRequest](_l) {
  ...
  ): _root_.com.zitadel.management.v1.management.UpdateGoogleProviderRequest = _root_.com.zitadel.management.v1.management.UpdateGoogleProviderRequest(
    id,
    name,
    clientId,
    clientSecret,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.management.v1.UpdateGoogleProviderRequest])
}
