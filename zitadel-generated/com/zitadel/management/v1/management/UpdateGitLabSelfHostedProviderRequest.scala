...
/** @param clientSecret
  ...
  */
@SerialVersionUID(0L)
final case class UpdateGitLabSelfHostedProviderRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[UpdateGitLabSelfHostedProviderRequest] {
    @transient
    ...
    def withId(__v: _root_.scala.Predef.String): UpdateGitLabSelfHostedProviderRequest = copy(id = __v)
    def withIssuer(__v: _root_.scala.Predef.String): UpdateGitLabSelfHostedProviderRequest = copy(issuer = __v)
    def withName(__v: _root_.scala.Predef.String): UpdateGitLabSelfHostedProviderRequest = copy(name = __v)
    def withClientId(__v: _root_.scala.Predef.String): UpdateGitLabSelfHostedProviderRequest = copy(clientId = __v)
    def withClientSecret(__v: _root_.scala.Predef.String): UpdateGitLabSelfHostedProviderRequest = copy(clientSecret = __v)
    def clearScopes = copy(scopes = _root_.scala.Seq.empty)
    def addScopes(__vs: _root_.scala.Predef.String *): UpdateGitLabSelfHostedProviderRequest = addAllScopes(__vs)
    def addAllScopes(__vs: Iterable[_root_.scala.Predef.String]): UpdateGitLabSelfHostedProviderRequest = copy(scopes = scopes ++ __vs)
    def withScopes(__v: _root_.scala.Seq[_root_.scala.Predef.String]): UpdateGitLabSelfHostedProviderRequest = copy(scopes = __v)
    ...
    def clearProviderOptions: UpdateGitLabSelfHostedProviderRequest = copy(providerOptions = _root_.scala.None)
    def withProviderOptions(__v: com.zitadel.idp.v1.idp.Options): UpdateGitLabSelfHostedProviderRequest = copy(providerOptions = Option(__v))
    ...
    def companion: com.zitadel.management.v1.management.UpdateGitLabSelfHostedProviderRequest.type = com.zitadel.management.v1.management.UpdateGitLabSelfHostedProviderRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.management.v1.UpdateGitLabSelfHostedProviderRequest])
}

object UpdateGitLabSelfHostedProviderRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.UpdateGitLabSelfHostedProviderRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.UpdateGitLabSelfHostedProviderRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.management.v1.management.UpdateGitLabSelfHostedProviderRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.management.v1.management.UpdateGitLabSelfHostedProviderRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ManagementProto.javaDescriptor.getMessageTypes().get(520)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ManagementProto.scalaDescriptor.messages(520)
  ...
  lazy val defaultInstance = com.zitadel.management.v1.management.UpdateGitLabSelfHostedProviderRequest(
    id = "",
    issuer = "",
    name = "",
    clientId = "",
  ...
  implicit class UpdateGitLabSelfHostedProviderRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.management.v1.management.UpdateGitLabSelfHostedProviderRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.management.v1.management.UpdateGitLabSelfHostedProviderRequest](_l) {
  ...
  ): _root_.com.zitadel.management.v1.management.UpdateGitLabSelfHostedProviderRequest = _root_.com.zitadel.management.v1.management.UpdateGitLabSelfHostedProviderRequest(
    id,
    issuer,
    name,
    clientId,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.management.v1.UpdateGitLabSelfHostedProviderRequest])
}
