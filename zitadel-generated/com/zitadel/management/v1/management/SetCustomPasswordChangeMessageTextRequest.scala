...
@SerialVersionUID(0L)
final case class SetCustomPasswordChangeMessageTextRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[SetCustomPasswordChangeMessageTextRequest] {
    @transient
    ...
    def withLanguage(__v: _root_.scala.Predef.String): SetCustomPasswordChangeMessageTextRequest = copy(language = __v)
    def withTitle(__v: _root_.scala.Predef.String): SetCustomPasswordChangeMessageTextRequest = copy(title = __v)
    def withPreHeader(__v: _root_.scala.Predef.String): SetCustomPasswordChangeMessageTextRequest = copy(preHeader = __v)
    def withSubject(__v: _root_.scala.Predef.String): SetCustomPasswordChangeMessageTextRequest = copy(subject = __v)
    def withGreeting(__v: _root_.scala.Predef.String): SetCustomPasswordChangeMessageTextRequest = copy(greeting = __v)
    def withText(__v: _root_.scala.Predef.String): SetCustomPasswordChangeMessageTextRequest = copy(text = __v)
    def withButtonText(__v: _root_.scala.Predef.String): SetCustomPasswordChangeMessageTextRequest = copy(buttonText = __v)
    def withFooterText(__v: _root_.scala.Predef.String): SetCustomPasswordChangeMessageTextRequest = copy(footerText = __v)
    ...
    def companion: com.zitadel.management.v1.management.SetCustomPasswordChangeMessageTextRequest.type = com.zitadel.management.v1.management.SetCustomPasswordChangeMessageTextRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.management.v1.SetCustomPasswordChangeMessageTextRequest])
}

object SetCustomPasswordChangeMessageTextRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.SetCustomPasswordChangeMessageTextRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.SetCustomPasswordChangeMessageTextRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.management.v1.management.SetCustomPasswordChangeMessageTextRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.management.v1.management.SetCustomPasswordChangeMessageTextRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ManagementProto.javaDescriptor.getMessageTypes().get(458)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ManagementProto.scalaDescriptor.messages(458)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = com.zitadel.management.v1.management.SetCustomPasswordChangeMessageTextRequest(
    language = "",
    title = "",
    preHeader = "",
    subject = "",
  ...
  implicit class SetCustomPasswordChangeMessageTextRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.management.v1.management.SetCustomPasswordChangeMessageTextRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.management.v1.management.SetCustomPasswordChangeMessageTextRequest](_l) {
  ...
  def of(
    ...
    buttonText: _root_.scala.Predef.String,
    footerText: _root_.scala.Predef.String
  ): _root_.com.zitadel.management.v1.management.SetCustomPasswordChangeMessageTextRequest = _root_.com.zitadel.management.v1.management.SetCustomPasswordChangeMessageTextRequest(
    language,
    title,
    preHeader,
    subject,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.management.v1.SetCustomPasswordChangeMessageTextRequest])
}
