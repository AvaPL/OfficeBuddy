...
final case class AddAzureADProviderRequest(
    ...
    def companion: com.zitadel.management.v1.management.AddAzureADProviderRequest.type = com.zitadel.management.v1.management.AddAzureADProviderRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.management.v1.AddAzureADProviderRequest])
}

object AddAzureADProviderRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.AddAzureADProviderRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.AddAzureADProviderRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.management.v1.management.AddAzureADProviderRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.management.v1.management.AddAzureADProviderRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ManagementProto.javaDescriptor.getMessageTypes().get(502)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ManagementProto.scalaDescriptor.messages(502)
  ...
  lazy val defaultInstance = com.zitadel.management.v1.management.AddAzureADProviderRequest(
    name = "",
    clientId = "",
    clientSecret = "",
  ...
  implicit class AddAzureADProviderRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.management.v1.management.AddAzureADProviderRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.management.v1.management.AddAzureADProviderRequest](_l) {
  ...
  ): _root_.com.zitadel.management.v1.management.AddAzureADProviderRequest = _root_.com.zitadel.management.v1.management.AddAzureADProviderRequest(
    name,
    clientId,
    clientSecret,
    tenant,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.management.v1.AddAzureADProviderRequest])
}
