...
final case class GetLockoutPolicyResponse(
    ...
    def withIsDefault(__v: _root_.scala.Boolean): GetLockoutPolicyResponse = copy(isDefault = __v)
    ...
    def companion: com.zitadel.management.v1.management.GetLockoutPolicyResponse.type = com.zitadel.management.v1.management.GetLockoutPolicyResponse
    // @@protoc_insertion_point(GeneratedMessage[zitadel.management.v1.GetLockoutPolicyResponse])
}

object GetLockoutPolicyResponse extends scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.GetLockoutPolicyResponse] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.GetLockoutPolicyResponse] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.management.v1.management.GetLockoutPolicyResponse = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.management.v1.management.GetLockoutPolicyResponse] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ManagementProto.javaDescriptor.getMessageTypes().get(345)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ManagementProto.scalaDescriptor.messages(345)
  ...
  lazy val defaultInstance = com.zitadel.management.v1.management.GetLockoutPolicyResponse(
    policy = _root_.scala.None,
    isDefault = false
  )
  implicit class GetLockoutPolicyResponseLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.management.v1.management.GetLockoutPolicyResponse]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.management.v1.management.GetLockoutPolicyResponse](_l) {
  ...
  ): _root_.com.zitadel.management.v1.management.GetLockoutPolicyResponse = _root_.com.zitadel.management.v1.management.GetLockoutPolicyResponse(
    policy,
    isDefault
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.management.v1.GetLockoutPolicyResponse])
}
