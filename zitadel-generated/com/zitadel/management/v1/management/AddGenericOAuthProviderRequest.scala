...
/** @param idAttribute
  ...
  */
@SerialVersionUID(0L)
final case class AddGenericOAuthProviderRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[AddGenericOAuthProviderRequest] {
    @transient
    ...
    def withName(__v: _root_.scala.Predef.String): AddGenericOAuthProviderRequest = copy(name = __v)
    def withClientId(__v: _root_.scala.Predef.String): AddGenericOAuthProviderRequest = copy(clientId = __v)
    def withClientSecret(__v: _root_.scala.Predef.String): AddGenericOAuthProviderRequest = copy(clientSecret = __v)
    def withAuthorizationEndpoint(__v: _root_.scala.Predef.String): AddGenericOAuthProviderRequest = copy(authorizationEndpoint = __v)
    def withTokenEndpoint(__v: _root_.scala.Predef.String): AddGenericOAuthProviderRequest = copy(tokenEndpoint = __v)
    def withUserEndpoint(__v: _root_.scala.Predef.String): AddGenericOAuthProviderRequest = copy(userEndpoint = __v)
    def clearScopes = copy(scopes = _root_.scala.Seq.empty)
    def addScopes(__vs: _root_.scala.Predef.String *): AddGenericOAuthProviderRequest = addAllScopes(__vs)
    def addAllScopes(__vs: Iterable[_root_.scala.Predef.String]): AddGenericOAuthProviderRequest = copy(scopes = scopes ++ __vs)
    def withScopes(__v: _root_.scala.Seq[_root_.scala.Predef.String]): AddGenericOAuthProviderRequest = copy(scopes = __v)
    def withIdAttribute(__v: _root_.scala.Predef.String): AddGenericOAuthProviderRequest = copy(idAttribute = __v)
    ...
    def clearProviderOptions: AddGenericOAuthProviderRequest = copy(providerOptions = _root_.scala.None)
    def withProviderOptions(__v: com.zitadel.idp.v1.idp.Options): AddGenericOAuthProviderRequest = copy(providerOptions = Option(__v))
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 8 => _root_.scalapb.descriptors.PString(idAttribute)
        case 9 => providerOptions.map(_.toPMessage).getOrElse(_root_.scalapb.descriptors.PEmpty)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion: com.zitadel.management.v1.management.AddGenericOAuthProviderRequest.type = com.zitadel.management.v1.management.AddGenericOAuthProviderRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.management.v1.AddGenericOAuthProviderRequest])
}

object AddGenericOAuthProviderRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.AddGenericOAuthProviderRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.AddGenericOAuthProviderRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.management.v1.management.AddGenericOAuthProviderRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.management.v1.management.AddGenericOAuthProviderRequest] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      com.zitadel.management.v1.management.AddGenericOAuthProviderRequest(
        ...
        idAttribute = __fieldsMap.get(scalaDescriptor.findFieldByNumber(8).get).map(_.as[_root_.scala.Predef.String]).getOrElse(""),
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ManagementProto.javaDescriptor.getMessageTypes().get(488)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ManagementProto.scalaDescriptor.messages(488)
  ...
  lazy val defaultInstance = com.zitadel.management.v1.management.AddGenericOAuthProviderRequest(
    name = "",
    clientId = "",
    clientSecret = "",
  ...
  implicit class AddGenericOAuthProviderRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.management.v1.management.AddGenericOAuthProviderRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.management.v1.management.AddGenericOAuthProviderRequest](_l) {
  ...
  final val ID_ATTRIBUTE_FIELD_NUMBER = 8
  ...
  ): _root_.com.zitadel.management.v1.management.AddGenericOAuthProviderRequest = _root_.com.zitadel.management.v1.management.AddGenericOAuthProviderRequest(
    name,
    clientId,
    clientSecret,
    authorizationEndpoint,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.management.v1.AddGenericOAuthProviderRequest])
}
