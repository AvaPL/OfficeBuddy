...
@SerialVersionUID(0L)
final case class AddGitLabSelfHostedProviderRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[AddGitLabSelfHostedProviderRequest] {
    @transient
    ...
    def withIssuer(__v: _root_.scala.Predef.String): AddGitLabSelfHostedProviderRequest = copy(issuer = __v)
    def withName(__v: _root_.scala.Predef.String): AddGitLabSelfHostedProviderRequest = copy(name = __v)
    def withClientId(__v: _root_.scala.Predef.String): AddGitLabSelfHostedProviderRequest = copy(clientId = __v)
    def withClientSecret(__v: _root_.scala.Predef.String): AddGitLabSelfHostedProviderRequest = copy(clientSecret = __v)
    def clearScopes = copy(scopes = _root_.scala.Seq.empty)
    def addScopes(__vs: _root_.scala.Predef.String *): AddGitLabSelfHostedProviderRequest = addAllScopes(__vs)
    def addAllScopes(__vs: Iterable[_root_.scala.Predef.String]): AddGitLabSelfHostedProviderRequest = copy(scopes = scopes ++ __vs)
    def withScopes(__v: _root_.scala.Seq[_root_.scala.Predef.String]): AddGitLabSelfHostedProviderRequest = copy(scopes = __v)
    ...
    def clearProviderOptions: AddGitLabSelfHostedProviderRequest = copy(providerOptions = _root_.scala.None)
    def withProviderOptions(__v: com.zitadel.idp.v1.idp.Options): AddGitLabSelfHostedProviderRequest = copy(providerOptions = Option(__v))
    ...
    def companion: com.zitadel.management.v1.management.AddGitLabSelfHostedProviderRequest.type = com.zitadel.management.v1.management.AddGitLabSelfHostedProviderRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.management.v1.AddGitLabSelfHostedProviderRequest])
}

object AddGitLabSelfHostedProviderRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.AddGitLabSelfHostedProviderRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.AddGitLabSelfHostedProviderRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.management.v1.management.AddGitLabSelfHostedProviderRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.management.v1.management.AddGitLabSelfHostedProviderRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ManagementProto.javaDescriptor.getMessageTypes().get(518)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ManagementProto.scalaDescriptor.messages(518)
  ...
  lazy val defaultInstance = com.zitadel.management.v1.management.AddGitLabSelfHostedProviderRequest(
    issuer = "",
    name = "",
    clientId = "",
    clientSecret = "",
  ...
  implicit class AddGitLabSelfHostedProviderRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.management.v1.management.AddGitLabSelfHostedProviderRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.management.v1.management.AddGitLabSelfHostedProviderRequest](_l) {
  ...
  ): _root_.com.zitadel.management.v1.management.AddGitLabSelfHostedProviderRequest = _root_.com.zitadel.management.v1.management.AddGitLabSelfHostedProviderRequest(
    issuer,
    name,
    clientId,
    clientSecret,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.management.v1.AddGitLabSelfHostedProviderRequest])
}
