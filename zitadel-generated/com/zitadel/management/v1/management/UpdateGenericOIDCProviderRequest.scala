...
final case class UpdateGenericOIDCProviderRequest(
    ...
    def companion: com.zitadel.management.v1.management.UpdateGenericOIDCProviderRequest.type = com.zitadel.management.v1.management.UpdateGenericOIDCProviderRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.management.v1.UpdateGenericOIDCProviderRequest])
}

object UpdateGenericOIDCProviderRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.UpdateGenericOIDCProviderRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.UpdateGenericOIDCProviderRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.management.v1.management.UpdateGenericOIDCProviderRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.management.v1.management.UpdateGenericOIDCProviderRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ManagementProto.javaDescriptor.getMessageTypes().get(494)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ManagementProto.scalaDescriptor.messages(494)
  ...
  lazy val defaultInstance = com.zitadel.management.v1.management.UpdateGenericOIDCProviderRequest(
    id = "",
    name = "",
    issuer = "",
    clientId = "",
  ...
  implicit class UpdateGenericOIDCProviderRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.management.v1.management.UpdateGenericOIDCProviderRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.management.v1.management.UpdateGenericOIDCProviderRequest](_l) {
  ...
  ): _root_.com.zitadel.management.v1.management.UpdateGenericOIDCProviderRequest = _root_.com.zitadel.management.v1.management.UpdateGenericOIDCProviderRequest(
    id,
    name,
    issuer,
    clientId,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.management.v1.UpdateGenericOIDCProviderRequest])
}
