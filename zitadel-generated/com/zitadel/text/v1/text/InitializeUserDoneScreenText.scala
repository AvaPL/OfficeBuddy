...
@SerialVersionUID(0L)
final case class InitializeUserDoneScreenText(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[InitializeUserDoneScreenText] {
    @transient
    ...
    def withTitle(__v: _root_.scala.Predef.String): InitializeUserDoneScreenText = copy(title = __v)
    def withDescription(__v: _root_.scala.Predef.String): InitializeUserDoneScreenText = copy(description = __v)
    def withCancelButtonText(__v: _root_.scala.Predef.String): InitializeUserDoneScreenText = copy(cancelButtonText = __v)
    def withNextButtonText(__v: _root_.scala.Predef.String): InitializeUserDoneScreenText = copy(nextButtonText = __v)
    ...
    def companion: com.zitadel.text.v1.text.InitializeUserDoneScreenText.type = com.zitadel.text.v1.text.InitializeUserDoneScreenText
    // @@protoc_insertion_point(GeneratedMessage[zitadel.text.v1.InitializeUserDoneScreenText])
}

object InitializeUserDoneScreenText extends scalapb.GeneratedMessageCompanion[com.zitadel.text.v1.text.InitializeUserDoneScreenText] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.text.v1.text.InitializeUserDoneScreenText] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.text.v1.text.InitializeUserDoneScreenText = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.text.v1.text.InitializeUserDoneScreenText] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = TextProto.javaDescriptor.getMessageTypes().get(12)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = TextProto.scalaDescriptor.messages(12)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = com.zitadel.text.v1.text.InitializeUserDoneScreenText(
    title = "",
    description = "",
    cancelButtonText = "",
    nextButtonText = ""
  )
  implicit class InitializeUserDoneScreenTextLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.text.v1.text.InitializeUserDoneScreenText]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.text.v1.text.InitializeUserDoneScreenText](_l) {
  ...
  def of(
    ...
    cancelButtonText: _root_.scala.Predef.String,
    nextButtonText: _root_.scala.Predef.String
  ): _root_.com.zitadel.text.v1.text.InitializeUserDoneScreenText = _root_.com.zitadel.text.v1.text.InitializeUserDoneScreenText(
    title,
    description,
    cancelButtonText,
    nextButtonText
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.text.v1.InitializeUserDoneScreenText])
}
