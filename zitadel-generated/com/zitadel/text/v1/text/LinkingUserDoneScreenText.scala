...
@SerialVersionUID(0L)
final case class LinkingUserDoneScreenText(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[LinkingUserDoneScreenText] {
    @transient
    ...
    def withTitle(__v: _root_.scala.Predef.String): LinkingUserDoneScreenText = copy(title = __v)
    def withDescription(__v: _root_.scala.Predef.String): LinkingUserDoneScreenText = copy(description = __v)
    def withCancelButtonText(__v: _root_.scala.Predef.String): LinkingUserDoneScreenText = copy(cancelButtonText = __v)
    def withNextButtonText(__v: _root_.scala.Predef.String): LinkingUserDoneScreenText = copy(nextButtonText = __v)
    ...
    def companion: com.zitadel.text.v1.text.LinkingUserDoneScreenText.type = com.zitadel.text.v1.text.LinkingUserDoneScreenText
    // @@protoc_insertion_point(GeneratedMessage[zitadel.text.v1.LinkingUserDoneScreenText])
}

object LinkingUserDoneScreenText extends scalapb.GeneratedMessageCompanion[com.zitadel.text.v1.text.LinkingUserDoneScreenText] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.text.v1.text.LinkingUserDoneScreenText] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.text.v1.text.LinkingUserDoneScreenText = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.text.v1.text.LinkingUserDoneScreenText] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = TextProto.javaDescriptor.getMessageTypes().get(28)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = TextProto.scalaDescriptor.messages(28)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = com.zitadel.text.v1.text.LinkingUserDoneScreenText(
    title = "",
    description = "",
    cancelButtonText = "",
    nextButtonText = ""
  )
  implicit class LinkingUserDoneScreenTextLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.text.v1.text.LinkingUserDoneScreenText]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.text.v1.text.LinkingUserDoneScreenText](_l) {
  ...
  def of(
    ...
    cancelButtonText: _root_.scala.Predef.String,
    nextButtonText: _root_.scala.Predef.String
  ): _root_.com.zitadel.text.v1.text.LinkingUserDoneScreenText = _root_.com.zitadel.text.v1.text.LinkingUserDoneScreenText(
    title,
    description,
    cancelButtonText,
    nextButtonText
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.text.v1.LinkingUserDoneScreenText])
}
