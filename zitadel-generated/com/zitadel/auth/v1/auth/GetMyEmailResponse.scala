...
@SerialVersionUID(0L)
final case class GetMyEmailResponse(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[GetMyEmailResponse] {
    @transient
    ...
    def clearDetails: GetMyEmailResponse = copy(details = _root_.scala.None)
    def withDetails(__v: com.zitadel.v1.`object`.ObjectDetails): GetMyEmailResponse = copy(details = Option(__v))
    def getEmail: com.zitadel.user.v1.user.Email = email.getOrElse(com.zitadel.user.v1.user.Email.defaultInstance)
    def clearEmail: GetMyEmailResponse = copy(email = _root_.scala.None)
    def withEmail(__v: com.zitadel.user.v1.user.Email): GetMyEmailResponse = copy(email = Option(__v))
    ...
    def companion: com.zitadel.auth.v1.auth.GetMyEmailResponse.type = com.zitadel.auth.v1.auth.GetMyEmailResponse
    // @@protoc_insertion_point(GeneratedMessage[zitadel.auth.v1.GetMyEmailResponse])
}

object GetMyEmailResponse extends scalapb.GeneratedMessageCompanion[com.zitadel.auth.v1.auth.GetMyEmailResponse] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.auth.v1.auth.GetMyEmailResponse] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.auth.v1.auth.GetMyEmailResponse = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.auth.v1.auth.GetMyEmailResponse] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = AuthProto.javaDescriptor.getMessageTypes().get(41)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = AuthProto.scalaDescriptor.messages(41)
  ...
  lazy val defaultInstance = com.zitadel.auth.v1.auth.GetMyEmailResponse(
    details = _root_.scala.None,
    email = _root_.scala.None
  )
  implicit class GetMyEmailResponseLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.auth.v1.auth.GetMyEmailResponse]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.auth.v1.auth.GetMyEmailResponse](_l) {
  ...
  ): _root_.com.zitadel.auth.v1.auth.GetMyEmailResponse = _root_.com.zitadel.auth.v1.auth.GetMyEmailResponse(
    details,
    email
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.auth.v1.GetMyEmailResponse])
}
