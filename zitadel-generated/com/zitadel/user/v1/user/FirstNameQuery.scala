...
final case class FirstNameQuery(
    ...
    def companion: com.zitadel.user.v1.user.FirstNameQuery.type = com.zitadel.user.v1.user.FirstNameQuery
    // @@protoc_insertion_point(GeneratedMessage[zitadel.user.v1.FirstNameQuery])
}

object FirstNameQuery extends scalapb.GeneratedMessageCompanion[com.zitadel.user.v1.user.FirstNameQuery] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.user.v1.user.FirstNameQuery] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.user.v1.user.FirstNameQuery = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.user.v1.user.FirstNameQuery] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = com.zitadel.user.v1.user.FirstNameQuery(
    firstName = "",
    method = com.zitadel.v1.`object`.TextQueryMethod.TEXT_QUERY_METHOD_EQUALS
  )
  implicit class FirstNameQueryLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.user.v1.user.FirstNameQuery]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.user.v1.user.FirstNameQuery](_l) {
  ...
  ): _root_.com.zitadel.user.v1.user.FirstNameQuery = _root_.com.zitadel.user.v1.user.FirstNameQuery(
    firstName,
    method
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.user.v1.FirstNameQuery])
}
