...
@SerialVersionUID(0L)
final case class DisplayNameQuery(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[DisplayNameQuery] {
    @transient
    ...
    def withDisplayName(__v: _root_.scala.Predef.String): DisplayNameQuery = copy(displayName = __v)
    def withMethod(__v: com.zitadel.v1.`object`.TextQueryMethod): DisplayNameQuery = copy(method = __v)
    ...
    def companion: com.zitadel.user.v1.user.DisplayNameQuery.type = com.zitadel.user.v1.user.DisplayNameQuery
    // @@protoc_insertion_point(GeneratedMessage[zitadel.user.v1.DisplayNameQuery])
}

object DisplayNameQuery extends scalapb.GeneratedMessageCompanion[com.zitadel.user.v1.user.DisplayNameQuery] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.user.v1.user.DisplayNameQuery] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.user.v1.user.DisplayNameQuery = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.user.v1.user.DisplayNameQuery] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = com.zitadel.user.v1.user.DisplayNameQuery(
    displayName = "",
    method = com.zitadel.v1.`object`.TextQueryMethod.TEXT_QUERY_METHOD_EQUALS
  )
  implicit class DisplayNameQueryLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.user.v1.user.DisplayNameQuery]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.user.v1.user.DisplayNameQuery](_l) {
  ...
  ): _root_.com.zitadel.user.v1.user.DisplayNameQuery = _root_.com.zitadel.user.v1.user.DisplayNameQuery(
    displayName,
    method
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.user.v1.DisplayNameQuery])
}
