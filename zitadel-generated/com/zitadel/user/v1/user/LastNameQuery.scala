...
final case class LastNameQuery(
    ...
    def companion: com.zitadel.user.v1.user.LastNameQuery.type = com.zitadel.user.v1.user.LastNameQuery
    // @@protoc_insertion_point(GeneratedMessage[zitadel.user.v1.LastNameQuery])
}

object LastNameQuery extends scalapb.GeneratedMessageCompanion[com.zitadel.user.v1.user.LastNameQuery] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.user.v1.user.LastNameQuery] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.user.v1.user.LastNameQuery = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.user.v1.user.LastNameQuery] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = com.zitadel.user.v1.user.LastNameQuery(
    lastName = "",
    method = com.zitadel.v1.`object`.TextQueryMethod.TEXT_QUERY_METHOD_EQUALS
  )
  implicit class LastNameQueryLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.user.v1.user.LastNameQuery]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.user.v1.user.LastNameQuery](_l) {
  ...
  ): _root_.com.zitadel.user.v1.user.LastNameQuery = _root_.com.zitadel.user.v1.user.LastNameQuery(
    lastName,
    method
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.user.v1.LastNameQuery])
}
