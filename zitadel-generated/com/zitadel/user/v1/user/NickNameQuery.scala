...
@SerialVersionUID(0L)
final case class NickNameQuery(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[NickNameQuery] {
    @transient
    ...
    def withNickName(__v: _root_.scala.Predef.String): NickNameQuery = copy(nickName = __v)
    def withMethod(__v: com.zitadel.v1.`object`.TextQueryMethod): NickNameQuery = copy(method = __v)
    ...
    def companion: com.zitadel.user.v1.user.NickNameQuery.type = com.zitadel.user.v1.user.NickNameQuery
    // @@protoc_insertion_point(GeneratedMessage[zitadel.user.v1.NickNameQuery])
}

object NickNameQuery extends scalapb.GeneratedMessageCompanion[com.zitadel.user.v1.user.NickNameQuery] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.user.v1.user.NickNameQuery] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.user.v1.user.NickNameQuery = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.user.v1.user.NickNameQuery] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = com.zitadel.user.v1.user.NickNameQuery(
    nickName = "",
    method = com.zitadel.v1.`object`.TextQueryMethod.TEXT_QUERY_METHOD_EQUALS
  )
  implicit class NickNameQueryLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.user.v1.user.NickNameQuery]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.user.v1.user.NickNameQuery](_l) {
  ...
  final val NICK_NAME_FIELD_NUMBER = 1
  final val METHOD_FIELD_NUMBER = 2
  def of(
    nickName: _root_.scala.Predef.String,
    method: com.zitadel.v1.`object`.TextQueryMethod
  ): _root_.com.zitadel.user.v1.user.NickNameQuery = _root_.com.zitadel.user.v1.user.NickNameQuery(
    nickName,
    method
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.user.v1.NickNameQuery])
}
