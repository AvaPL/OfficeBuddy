...
final case class Instance(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[Instance] {
    @transient
    ...
    def withId(__v: _root_.scala.Predef.String): Instance = copy(id = __v)
    def getDetails: com.zitadel.v1.`object`.ObjectDetails = details.getOrElse(com.zitadel.v1.`object`.ObjectDetails.defaultInstance)
    def clearDetails: Instance = copy(details = _root_.scala.None)
    def withDetails(__v: com.zitadel.v1.`object`.ObjectDetails): Instance = copy(details = Option(__v))
    def withState(__v: com.zitadel.instance.v1.instance.State): Instance = copy(state = __v)
    def withName(__v: _root_.scala.Predef.String): Instance = copy(name = __v)
    def withVersion(__v: _root_.scala.Predef.String): Instance = copy(version = __v)
    def clearDomains = copy(domains = _root_.scala.Seq.empty)
    def addDomains(__vs: com.zitadel.instance.v1.instance.Domain *): Instance = addAllDomains(__vs)
    def addAllDomains(__vs: Iterable[com.zitadel.instance.v1.instance.Domain]): Instance = copy(domains = domains ++ __vs)
    def withDomains(__v: _root_.scala.Seq[com.zitadel.instance.v1.instance.Domain]): Instance = copy(domains = __v)
    ...
    def companion: com.zitadel.instance.v1.instance.Instance.type = com.zitadel.instance.v1.instance.Instance
    // @@protoc_insertion_point(GeneratedMessage[zitadel.instance.v1.Instance])
}

object Instance extends scalapb.GeneratedMessageCompanion[com.zitadel.instance.v1.instance.Instance] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.instance.v1.instance.Instance] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.instance.v1.instance.Instance = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.instance.v1.instance.Instance] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = InstanceProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = InstanceProto.scalaDescriptor.messages(0)
  ...
  lazy val defaultInstance = com.zitadel.instance.v1.instance.Instance(
    id = "",
  ...
  implicit class InstanceLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.instance.v1.instance.Instance]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.instance.v1.instance.Instance](_l) {
  ...
  ): _root_.com.zitadel.instance.v1.instance.Instance = _root_.com.zitadel.instance.v1.instance.Instance(
    id,
    details,
    state,
    name,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.instance.v1.Instance])
}
