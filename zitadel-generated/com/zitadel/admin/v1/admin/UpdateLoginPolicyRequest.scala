...
/** @param allowDomainDiscovery
  ...
  */
@SerialVersionUID(0L)
final case class UpdateLoginPolicyRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[UpdateLoginPolicyRequest] {
    @transient
    ...
    def withAllowUsernamePassword(__v: _root_.scala.Boolean): UpdateLoginPolicyRequest = copy(allowUsernamePassword = __v)
    def withAllowRegister(__v: _root_.scala.Boolean): UpdateLoginPolicyRequest = copy(allowRegister = __v)
    def withAllowExternalIdp(__v: _root_.scala.Boolean): UpdateLoginPolicyRequest = copy(allowExternalIdp = __v)
    def withForceMfa(__v: _root_.scala.Boolean): UpdateLoginPolicyRequest = copy(forceMfa = __v)
    def withPasswordlessType(__v: com.zitadel.policy.v1.policy.PasswordlessType): UpdateLoginPolicyRequest = copy(passwordlessType = __v)
    def withHidePasswordReset(__v: _root_.scala.Boolean): UpdateLoginPolicyRequest = copy(hidePasswordReset = __v)
    def withIgnoreUnknownUsernames(__v: _root_.scala.Boolean): UpdateLoginPolicyRequest = copy(ignoreUnknownUsernames = __v)
    def withDefaultRedirectUri(__v: _root_.scala.Predef.String): UpdateLoginPolicyRequest = copy(defaultRedirectUri = __v)
    ...
    def clearPasswordCheckLifetime: UpdateLoginPolicyRequest = copy(passwordCheckLifetime = _root_.scala.None)
    def withPasswordCheckLifetime(__v: com.google.protobuf.duration.Duration): UpdateLoginPolicyRequest = copy(passwordCheckLifetime = Option(__v))
    ...
    def clearExternalLoginCheckLifetime: UpdateLoginPolicyRequest = copy(externalLoginCheckLifetime = _root_.scala.None)
    def withExternalLoginCheckLifetime(__v: com.google.protobuf.duration.Duration): UpdateLoginPolicyRequest = copy(externalLoginCheckLifetime = Option(__v))
    ...
    def clearMfaInitSkipLifetime: UpdateLoginPolicyRequest = copy(mfaInitSkipLifetime = _root_.scala.None)
    def withMfaInitSkipLifetime(__v: com.google.protobuf.duration.Duration): UpdateLoginPolicyRequest = copy(mfaInitSkipLifetime = Option(__v))
    ...
    def clearSecondFactorCheckLifetime: UpdateLoginPolicyRequest = copy(secondFactorCheckLifetime = _root_.scala.None)
    def withSecondFactorCheckLifetime(__v: com.google.protobuf.duration.Duration): UpdateLoginPolicyRequest = copy(secondFactorCheckLifetime = Option(__v))
    ...
    def clearMultiFactorCheckLifetime: UpdateLoginPolicyRequest = copy(multiFactorCheckLifetime = _root_.scala.None)
    def withMultiFactorCheckLifetime(__v: com.google.protobuf.duration.Duration): UpdateLoginPolicyRequest = copy(multiFactorCheckLifetime = Option(__v))
    def withAllowDomainDiscovery(__v: _root_.scala.Boolean): UpdateLoginPolicyRequest = copy(allowDomainDiscovery = __v)
    def withDisableLoginWithEmail(__v: _root_.scala.Boolean): UpdateLoginPolicyRequest = copy(disableLoginWithEmail = __v)
    def withDisableLoginWithPhone(__v: _root_.scala.Boolean): UpdateLoginPolicyRequest = copy(disableLoginWithPhone = __v)
    def withForceMfaLocalOnly(__v: _root_.scala.Boolean): UpdateLoginPolicyRequest = copy(forceMfaLocalOnly = __v)
    ...
    def companion: com.zitadel.admin.v1.admin.UpdateLoginPolicyRequest.type = com.zitadel.admin.v1.admin.UpdateLoginPolicyRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.admin.v1.UpdateLoginPolicyRequest])
}

object UpdateLoginPolicyRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.UpdateLoginPolicyRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.UpdateLoginPolicyRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.admin.v1.admin.UpdateLoginPolicyRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.admin.v1.admin.UpdateLoginPolicyRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = AdminProto.javaDescriptor.getMessageTypes().get(186)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = AdminProto.scalaDescriptor.messages(186)
  ...
  lazy val defaultInstance = com.zitadel.admin.v1.admin.UpdateLoginPolicyRequest(
  ...
  implicit class UpdateLoginPolicyRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.admin.v1.admin.UpdateLoginPolicyRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.admin.v1.admin.UpdateLoginPolicyRequest](_l) {
  ...
  ): _root_.com.zitadel.admin.v1.admin.UpdateLoginPolicyRequest = _root_.com.zitadel.admin.v1.admin.UpdateLoginPolicyRequest(
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.admin.v1.UpdateLoginPolicyRequest])
}
