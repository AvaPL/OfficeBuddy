...
@SerialVersionUID(0L)
final case class SetDefaultPasswordResetMessageTextRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[SetDefaultPasswordResetMessageTextRequest] {
    @transient
    ...
    def withLanguage(__v: _root_.scala.Predef.String): SetDefaultPasswordResetMessageTextRequest = copy(language = __v)
    def withTitle(__v: _root_.scala.Predef.String): SetDefaultPasswordResetMessageTextRequest = copy(title = __v)
    def withPreHeader(__v: _root_.scala.Predef.String): SetDefaultPasswordResetMessageTextRequest = copy(preHeader = __v)
    def withSubject(__v: _root_.scala.Predef.String): SetDefaultPasswordResetMessageTextRequest = copy(subject = __v)
    def withGreeting(__v: _root_.scala.Predef.String): SetDefaultPasswordResetMessageTextRequest = copy(greeting = __v)
    def withText(__v: _root_.scala.Predef.String): SetDefaultPasswordResetMessageTextRequest = copy(text = __v)
    def withButtonText(__v: _root_.scala.Predef.String): SetDefaultPasswordResetMessageTextRequest = copy(buttonText = __v)
    def withFooterText(__v: _root_.scala.Predef.String): SetDefaultPasswordResetMessageTextRequest = copy(footerText = __v)
    ...
    def companion: com.zitadel.admin.v1.admin.SetDefaultPasswordResetMessageTextRequest.type = com.zitadel.admin.v1.admin.SetDefaultPasswordResetMessageTextRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.admin.v1.SetDefaultPasswordResetMessageTextRequest])
}

object SetDefaultPasswordResetMessageTextRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.SetDefaultPasswordResetMessageTextRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.SetDefaultPasswordResetMessageTextRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.admin.v1.admin.SetDefaultPasswordResetMessageTextRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.admin.v1.admin.SetDefaultPasswordResetMessageTextRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = AdminProto.javaDescriptor.getMessageTypes().get(240)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = AdminProto.scalaDescriptor.messages(240)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = com.zitadel.admin.v1.admin.SetDefaultPasswordResetMessageTextRequest(
    language = "",
    title = "",
    preHeader = "",
    subject = "",
  ...
  implicit class SetDefaultPasswordResetMessageTextRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.admin.v1.admin.SetDefaultPasswordResetMessageTextRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.admin.v1.admin.SetDefaultPasswordResetMessageTextRequest](_l) {
  ...
  def of(
    ...
    buttonText: _root_.scala.Predef.String,
    footerText: _root_.scala.Predef.String
  ): _root_.com.zitadel.admin.v1.admin.SetDefaultPasswordResetMessageTextRequest = _root_.com.zitadel.admin.v1.admin.SetDefaultPasswordResetMessageTextRequest(
    language,
    title,
    preHeader,
    subject,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.admin.v1.SetDefaultPasswordResetMessageTextRequest])
}
