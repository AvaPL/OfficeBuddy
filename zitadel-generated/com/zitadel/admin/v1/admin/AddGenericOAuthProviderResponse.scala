...
final case class AddGenericOAuthProviderResponse(
    ...
    def companion: com.zitadel.admin.v1.admin.AddGenericOAuthProviderResponse.type = com.zitadel.admin.v1.admin.AddGenericOAuthProviderResponse
    // @@protoc_insertion_point(GeneratedMessage[zitadel.admin.v1.AddGenericOAuthProviderResponse])
}

object AddGenericOAuthProviderResponse extends scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.AddGenericOAuthProviderResponse] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.AddGenericOAuthProviderResponse] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.admin.v1.admin.AddGenericOAuthProviderResponse = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.admin.v1.admin.AddGenericOAuthProviderResponse] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = AdminProto.javaDescriptor.getMessageTypes().get(99)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = AdminProto.scalaDescriptor.messages(99)
  ...
  lazy val defaultInstance = com.zitadel.admin.v1.admin.AddGenericOAuthProviderResponse(
    details = _root_.scala.None,
    id = ""
  )
  implicit class AddGenericOAuthProviderResponseLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.admin.v1.admin.AddGenericOAuthProviderResponse]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.admin.v1.admin.AddGenericOAuthProviderResponse](_l) {
  ...
  def of(
    ...
    id: _root_.scala.Predef.String
  ): _root_.com.zitadel.admin.v1.admin.AddGenericOAuthProviderResponse = _root_.com.zitadel.admin.v1.admin.AddGenericOAuthProviderResponse(
    details,
    id
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.admin.v1.AddGenericOAuthProviderResponse])
}
