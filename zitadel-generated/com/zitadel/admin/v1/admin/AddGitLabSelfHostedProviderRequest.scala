...
final case class AddGitLabSelfHostedProviderRequest(
    ...
    def companion: com.zitadel.admin.v1.admin.AddGitLabSelfHostedProviderRequest.type = com.zitadel.admin.v1.admin.AddGitLabSelfHostedProviderRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.admin.v1.AddGitLabSelfHostedProviderRequest])
}

object AddGitLabSelfHostedProviderRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.AddGitLabSelfHostedProviderRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.AddGitLabSelfHostedProviderRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.admin.v1.admin.AddGitLabSelfHostedProviderRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.admin.v1.admin.AddGitLabSelfHostedProviderRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = AdminProto.javaDescriptor.getMessageTypes().get(128)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = AdminProto.scalaDescriptor.messages(128)
  ...
  lazy val defaultInstance = com.zitadel.admin.v1.admin.AddGitLabSelfHostedProviderRequest(
    issuer = "",
    name = "",
    clientId = "",
    clientSecret = "",
  ...
  implicit class AddGitLabSelfHostedProviderRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.admin.v1.admin.AddGitLabSelfHostedProviderRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.admin.v1.admin.AddGitLabSelfHostedProviderRequest](_l) {
  ...
  ): _root_.com.zitadel.admin.v1.admin.AddGitLabSelfHostedProviderRequest = _root_.com.zitadel.admin.v1.admin.AddGitLabSelfHostedProviderRequest(
    issuer,
    name,
    clientId,
    clientSecret,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.admin.v1.AddGitLabSelfHostedProviderRequest])
}
