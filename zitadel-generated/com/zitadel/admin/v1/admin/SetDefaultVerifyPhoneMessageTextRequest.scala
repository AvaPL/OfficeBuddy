...
@SerialVersionUID(0L)
final case class SetDefaultVerifyPhoneMessageTextRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[SetDefaultVerifyPhoneMessageTextRequest] {
    @transient
    ...
    def withLanguage(__v: _root_.scala.Predef.String): SetDefaultVerifyPhoneMessageTextRequest = copy(language = __v)
    def withTitle(__v: _root_.scala.Predef.String): SetDefaultVerifyPhoneMessageTextRequest = copy(title = __v)
    def withPreHeader(__v: _root_.scala.Predef.String): SetDefaultVerifyPhoneMessageTextRequest = copy(preHeader = __v)
    def withSubject(__v: _root_.scala.Predef.String): SetDefaultVerifyPhoneMessageTextRequest = copy(subject = __v)
    def withGreeting(__v: _root_.scala.Predef.String): SetDefaultVerifyPhoneMessageTextRequest = copy(greeting = __v)
    def withText(__v: _root_.scala.Predef.String): SetDefaultVerifyPhoneMessageTextRequest = copy(text = __v)
    def withButtonText(__v: _root_.scala.Predef.String): SetDefaultVerifyPhoneMessageTextRequest = copy(buttonText = __v)
    def withFooterText(__v: _root_.scala.Predef.String): SetDefaultVerifyPhoneMessageTextRequest = copy(footerText = __v)
    ...
    def companion: com.zitadel.admin.v1.admin.SetDefaultVerifyPhoneMessageTextRequest.type = com.zitadel.admin.v1.admin.SetDefaultVerifyPhoneMessageTextRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.admin.v1.SetDefaultVerifyPhoneMessageTextRequest])
}

object SetDefaultVerifyPhoneMessageTextRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.SetDefaultVerifyPhoneMessageTextRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.SetDefaultVerifyPhoneMessageTextRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.admin.v1.admin.SetDefaultVerifyPhoneMessageTextRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.admin.v1.admin.SetDefaultVerifyPhoneMessageTextRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = AdminProto.javaDescriptor.getMessageTypes().get(256)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = AdminProto.scalaDescriptor.messages(256)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = com.zitadel.admin.v1.admin.SetDefaultVerifyPhoneMessageTextRequest(
    language = "",
    title = "",
    preHeader = "",
    subject = "",
  ...
  implicit class SetDefaultVerifyPhoneMessageTextRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.admin.v1.admin.SetDefaultVerifyPhoneMessageTextRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.admin.v1.admin.SetDefaultVerifyPhoneMessageTextRequest](_l) {
  ...
  def of(
    ...
    buttonText: _root_.scala.Predef.String,
    footerText: _root_.scala.Predef.String
  ): _root_.com.zitadel.admin.v1.admin.SetDefaultVerifyPhoneMessageTextRequest = _root_.com.zitadel.admin.v1.admin.SetDefaultVerifyPhoneMessageTextRequest(
    language,
    title,
    preHeader,
    subject,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.admin.v1.SetDefaultVerifyPhoneMessageTextRequest])
}
