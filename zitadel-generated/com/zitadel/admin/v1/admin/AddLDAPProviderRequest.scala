...
final case class AddLDAPProviderRequest(
    ...
    def companion: com.zitadel.admin.v1.admin.AddLDAPProviderRequest.type = com.zitadel.admin.v1.admin.AddLDAPProviderRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.admin.v1.AddLDAPProviderRequest])
}

object AddLDAPProviderRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.AddLDAPProviderRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.AddLDAPProviderRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.admin.v1.admin.AddLDAPProviderRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.admin.v1.admin.AddLDAPProviderRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = AdminProto.javaDescriptor.getMessageTypes().get(136)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = AdminProto.scalaDescriptor.messages(136)
  ...
  lazy val defaultInstance = com.zitadel.admin.v1.admin.AddLDAPProviderRequest(
    name = "",
  ...
  implicit class AddLDAPProviderRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.admin.v1.admin.AddLDAPProviderRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.admin.v1.admin.AddLDAPProviderRequest](_l) {
  ...
  ): _root_.com.zitadel.admin.v1.admin.AddLDAPProviderRequest = _root_.com.zitadel.admin.v1.admin.AddLDAPProviderRequest(
    name,
    servers,
    startTls,
    baseDn,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.admin.v1.AddLDAPProviderRequest])
}
