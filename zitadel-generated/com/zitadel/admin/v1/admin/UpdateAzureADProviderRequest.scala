...
final case class UpdateAzureADProviderRequest(
    ...
    def companion: com.zitadel.admin.v1.admin.UpdateAzureADProviderRequest.type = com.zitadel.admin.v1.admin.UpdateAzureADProviderRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.admin.v1.UpdateAzureADProviderRequest])
}

object UpdateAzureADProviderRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.UpdateAzureADProviderRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.UpdateAzureADProviderRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.admin.v1.admin.UpdateAzureADProviderRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.admin.v1.admin.UpdateAzureADProviderRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = AdminProto.javaDescriptor.getMessageTypes().get(114)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = AdminProto.scalaDescriptor.messages(114)
  ...
  lazy val defaultInstance = com.zitadel.admin.v1.admin.UpdateAzureADProviderRequest(
    id = "",
    name = "",
    clientId = "",
    clientSecret = "",
  ...
  implicit class UpdateAzureADProviderRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.admin.v1.admin.UpdateAzureADProviderRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.admin.v1.admin.UpdateAzureADProviderRequest](_l) {
  ...
  ): _root_.com.zitadel.admin.v1.admin.UpdateAzureADProviderRequest = _root_.com.zitadel.admin.v1.admin.UpdateAzureADProviderRequest(
    id,
    name,
    clientId,
    clientSecret,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.admin.v1.UpdateAzureADProviderRequest])
}
