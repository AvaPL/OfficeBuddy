...
final case class UpdateGitLabProviderRequest(
    ...
    def companion: com.zitadel.admin.v1.admin.UpdateGitLabProviderRequest.type = com.zitadel.admin.v1.admin.UpdateGitLabProviderRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.admin.v1.UpdateGitLabProviderRequest])
}

object UpdateGitLabProviderRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.UpdateGitLabProviderRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.UpdateGitLabProviderRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.admin.v1.admin.UpdateGitLabProviderRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.admin.v1.admin.UpdateGitLabProviderRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = AdminProto.javaDescriptor.getMessageTypes().get(126)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = AdminProto.scalaDescriptor.messages(126)
  ...
  lazy val defaultInstance = com.zitadel.admin.v1.admin.UpdateGitLabProviderRequest(
    id = "",
    name = "",
    clientId = "",
    clientSecret = "",
  ...
  implicit class UpdateGitLabProviderRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.admin.v1.admin.UpdateGitLabProviderRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.admin.v1.admin.UpdateGitLabProviderRequest](_l) {
  ...
  ): _root_.com.zitadel.admin.v1.admin.UpdateGitLabProviderRequest = _root_.com.zitadel.admin.v1.admin.UpdateGitLabProviderRequest(
    id,
    name,
    clientId,
    clientSecret,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.admin.v1.UpdateGitLabProviderRequest])
}
