...
final case class AddGenericOIDCProviderRequest(
    ...
    def companion: com.zitadel.admin.v1.admin.AddGenericOIDCProviderRequest.type = com.zitadel.admin.v1.admin.AddGenericOIDCProviderRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.admin.v1.AddGenericOIDCProviderRequest])
}

object AddGenericOIDCProviderRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.AddGenericOIDCProviderRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.AddGenericOIDCProviderRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.admin.v1.admin.AddGenericOIDCProviderRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.admin.v1.admin.AddGenericOIDCProviderRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = AdminProto.javaDescriptor.getMessageTypes().get(102)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = AdminProto.scalaDescriptor.messages(102)
  ...
  lazy val defaultInstance = com.zitadel.admin.v1.admin.AddGenericOIDCProviderRequest(
    name = "",
    issuer = "",
    clientId = "",
    clientSecret = "",
  ...
  implicit class AddGenericOIDCProviderRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.admin.v1.admin.AddGenericOIDCProviderRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.admin.v1.admin.AddGenericOIDCProviderRequest](_l) {
  ...
  ): _root_.com.zitadel.admin.v1.admin.AddGenericOIDCProviderRequest = _root_.com.zitadel.admin.v1.admin.AddGenericOIDCProviderRequest(
    name,
    issuer,
    clientId,
    clientSecret,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.admin.v1.AddGenericOIDCProviderRequest])
}
