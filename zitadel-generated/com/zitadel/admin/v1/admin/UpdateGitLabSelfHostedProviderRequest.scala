...
final case class UpdateGitLabSelfHostedProviderRequest(
    ...
    def companion: com.zitadel.admin.v1.admin.UpdateGitLabSelfHostedProviderRequest.type = com.zitadel.admin.v1.admin.UpdateGitLabSelfHostedProviderRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.admin.v1.UpdateGitLabSelfHostedProviderRequest])
}

object UpdateGitLabSelfHostedProviderRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.UpdateGitLabSelfHostedProviderRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.UpdateGitLabSelfHostedProviderRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.admin.v1.admin.UpdateGitLabSelfHostedProviderRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.admin.v1.admin.UpdateGitLabSelfHostedProviderRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = AdminProto.javaDescriptor.getMessageTypes().get(130)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = AdminProto.scalaDescriptor.messages(130)
  ...
  lazy val defaultInstance = com.zitadel.admin.v1.admin.UpdateGitLabSelfHostedProviderRequest(
    id = "",
    issuer = "",
    name = "",
    clientId = "",
  ...
  implicit class UpdateGitLabSelfHostedProviderRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.admin.v1.admin.UpdateGitLabSelfHostedProviderRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.admin.v1.admin.UpdateGitLabSelfHostedProviderRequest](_l) {
  ...
  ): _root_.com.zitadel.admin.v1.admin.UpdateGitLabSelfHostedProviderRequest = _root_.com.zitadel.admin.v1.admin.UpdateGitLabSelfHostedProviderRequest(
    id,
    issuer,
    name,
    clientId,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.admin.v1.UpdateGitLabSelfHostedProviderRequest])
}
