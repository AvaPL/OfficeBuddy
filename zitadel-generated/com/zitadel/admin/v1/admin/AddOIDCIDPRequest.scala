...
@SerialVersionUID(0L)
final case class AddOIDCIDPRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[AddOIDCIDPRequest] {
    @transient
    ...
    def withName(__v: _root_.scala.Predef.String): AddOIDCIDPRequest = copy(name = __v)
    def withStylingType(__v: com.zitadel.idp.v1.idp.IDPStylingType): AddOIDCIDPRequest = copy(stylingType = __v)
    def withClientId(__v: _root_.scala.Predef.String): AddOIDCIDPRequest = copy(clientId = __v)
    def withClientSecret(__v: _root_.scala.Predef.String): AddOIDCIDPRequest = copy(clientSecret = __v)
    def withIssuer(__v: _root_.scala.Predef.String): AddOIDCIDPRequest = copy(issuer = __v)
    def clearScopes = copy(scopes = _root_.scala.Seq.empty)
    def addScopes(__vs: _root_.scala.Predef.String *): AddOIDCIDPRequest = addAllScopes(__vs)
    def addAllScopes(__vs: Iterable[_root_.scala.Predef.String]): AddOIDCIDPRequest = copy(scopes = scopes ++ __vs)
    def withScopes(__v: _root_.scala.Seq[_root_.scala.Predef.String]): AddOIDCIDPRequest = copy(scopes = __v)
    def withDisplayNameMapping(__v: com.zitadel.idp.v1.idp.OIDCMappingField): AddOIDCIDPRequest = copy(displayNameMapping = __v)
    def withUsernameMapping(__v: com.zitadel.idp.v1.idp.OIDCMappingField): AddOIDCIDPRequest = copy(usernameMapping = __v)
    def withAutoRegister(__v: _root_.scala.Boolean): AddOIDCIDPRequest = copy(autoRegister = __v)
    ...
    def companion: com.zitadel.admin.v1.admin.AddOIDCIDPRequest.type = com.zitadel.admin.v1.admin.AddOIDCIDPRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.admin.v1.AddOIDCIDPRequest])
}

object AddOIDCIDPRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.AddOIDCIDPRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.AddOIDCIDPRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.admin.v1.admin.AddOIDCIDPRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.admin.v1.admin.AddOIDCIDPRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = AdminProto.javaDescriptor.getMessageTypes().get(77)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = AdminProto.scalaDescriptor.messages(77)
  ...
  lazy val defaultInstance = com.zitadel.admin.v1.admin.AddOIDCIDPRequest(
    name = "",
  ...
  implicit class AddOIDCIDPRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.admin.v1.admin.AddOIDCIDPRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.admin.v1.admin.AddOIDCIDPRequest](_l) {
  ...
  ): _root_.com.zitadel.admin.v1.admin.AddOIDCIDPRequest = _root_.com.zitadel.admin.v1.admin.AddOIDCIDPRequest(
    name,
    stylingType,
    clientId,
    clientSecret,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.admin.v1.AddOIDCIDPRequest])
}
