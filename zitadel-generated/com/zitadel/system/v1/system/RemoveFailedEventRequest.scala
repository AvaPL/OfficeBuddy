...
final case class RemoveFailedEventRequest(
    ...
    def withInstanceId(__v: _root_.scala.Predef.String): RemoveFailedEventRequest = copy(instanceId = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 4 => _root_.scalapb.descriptors.PString(instanceId)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion: com.zitadel.system.v1.system.RemoveFailedEventRequest.type = com.zitadel.system.v1.system.RemoveFailedEventRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.system.v1.RemoveFailedEventRequest])
}

object RemoveFailedEventRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.system.v1.system.RemoveFailedEventRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.system.v1.system.RemoveFailedEventRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.system.v1.system.RemoveFailedEventRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.system.v1.system.RemoveFailedEventRequest] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      com.zitadel.system.v1.system.RemoveFailedEventRequest(
        ...
        instanceId = __fieldsMap.get(scalaDescriptor.findFieldByNumber(4).get).map(_.as[_root_.scala.Predef.String]).getOrElse("")
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = SystemProto.javaDescriptor.getMessageTypes().get(39)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = SystemProto.scalaDescriptor.messages(39)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = com.zitadel.system.v1.system.RemoveFailedEventRequest(
    database = "",
    viewName = "",
    failedSequence = 0L,
    instanceId = ""
  )
  implicit class RemoveFailedEventRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.system.v1.system.RemoveFailedEventRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.system.v1.system.RemoveFailedEventRequest](_l) {
  ...
  final val INSTANCE_ID_FIELD_NUMBER = 4
  def of(
    database: _root_.scala.Predef.String,
    viewName: _root_.scala.Predef.String,
    failedSequence: _root_.scala.Long,
    instanceId: _root_.scala.Predef.String
  ): _root_.com.zitadel.system.v1.system.RemoveFailedEventRequest = _root_.com.zitadel.system.v1.system.RemoveFailedEventRequest(
    database,
    viewName,
    failedSequence,
    instanceId
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.system.v1.RemoveFailedEventRequest])
}
