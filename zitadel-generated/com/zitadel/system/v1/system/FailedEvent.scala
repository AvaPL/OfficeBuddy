...
final case class FailedEvent(
    ...
    def companion: com.zitadel.system.v1.system.FailedEvent.type = com.zitadel.system.v1.system.FailedEvent
    // @@protoc_insertion_point(GeneratedMessage[zitadel.system.v1.FailedEvent])
}

object FailedEvent extends scalapb.GeneratedMessageCompanion[com.zitadel.system.v1.system.FailedEvent] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.system.v1.system.FailedEvent] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.system.v1.system.FailedEvent = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.system.v1.system.FailedEvent] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = SystemProto.javaDescriptor.getMessageTypes().get(42)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = SystemProto.scalaDescriptor.messages(42)
  ...
  lazy val defaultInstance = com.zitadel.system.v1.system.FailedEvent(
    database = "",
    viewName = "",
    failedSequence = 0L,
    failureCount = 0L,
  ...
  implicit class FailedEventLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.system.v1.system.FailedEvent]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.system.v1.system.FailedEvent](_l) {
  ...
  ): _root_.com.zitadel.system.v1.system.FailedEvent = _root_.com.zitadel.system.v1.system.FailedEvent(
    database,
    viewName,
    failedSequence,
    failureCount,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.system.v1.FailedEvent])
}
