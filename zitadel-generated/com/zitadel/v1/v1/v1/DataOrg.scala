...
final case class DataOrg(
    ...
    iamPolicy: _root_.scala.Option[com.zitadel.v1.v1.v1.AddCustomOrgIAMPolicyRequest] = _root_.scala.None,
    ...
    triggerActions: _root_.scala.Seq[com.zitadel.v1.v1.v1.SetTriggerActionsRequest] = _root_.scala.Seq.empty,
    ...
    secondFactors: _root_.scala.Seq[com.zitadel.management.v1.management.AddSecondFactorToLoginPolicyRequest] = _root_.scala.Seq.empty,
    multiFactors: _root_.scala.Seq[com.zitadel.management.v1.management.AddMultiFactorToLoginPolicyRequest] = _root_.scala.Seq.empty,
    idps: _root_.scala.Seq[com.zitadel.management.v1.management.AddIDPToLoginPolicyRequest] = _root_.scala.Seq.empty,
    ...
    private[this] def __computeSerializedSize(): _root_.scala.Int = {
      ...
      if (iamPolicy.isDefined) {
        val __value = iamPolicy.get
        __size += 1 + _root_.com.google.protobuf.CodedOutputStream.computeUInt32SizeNoTag(__value.serializedSize) + __value.serializedSize
      };
      ...
      secondFactors.foreach { __item =>
        val __value = __item
        __size += 2 + _root_.com.google.protobuf.CodedOutputStream.computeUInt32SizeNoTag(__value.serializedSize) + __value.serializedSize
      }
      multiFactors.foreach { __item =>
        val __value = __item
        __size += 2 + _root_.com.google.protobuf.CodedOutputStream.computeUInt32SizeNoTag(__value.serializedSize) + __value.serializedSize
      }
      idps.foreach { __item =>
    ...
    def writeTo(`_output__`: _root_.com.google.protobuf.CodedOutputStream): _root_.scala.Unit = {
      ...
      secondFactors.foreach { __v =>
        val __m = __v
        _output__.writeTag(33, 2)
        _output__.writeUInt32NoTag(__m.serializedSize)
        __m.writeTo(_output__)
      };
      multiFactors.foreach { __v =>
        val __m = __v
    ...
    def getIamPolicy: com.zitadel.v1.v1.v1.AddCustomOrgIAMPolicyRequest = iamPolicy.getOrElse(com.zitadel.v1.v1.v1.AddCustomOrgIAMPolicyRequest.defaultInstance)
    def clearIamPolicy: DataOrg = copy(iamPolicy = _root_.scala.None)
    def withIamPolicy(__v: com.zitadel.v1.v1.v1.AddCustomOrgIAMPolicyRequest): DataOrg = copy(iamPolicy = Option(__v))
    ...
    def addTriggerActions(__vs: com.zitadel.v1.v1.v1.SetTriggerActionsRequest *): DataOrg = addAllTriggerActions(__vs)
    def addAllTriggerActions(__vs: Iterable[com.zitadel.v1.v1.v1.SetTriggerActionsRequest]): DataOrg = copy(triggerActions = triggerActions ++ __vs)
    def withTriggerActions(__v: _root_.scala.Seq[com.zitadel.v1.v1.v1.SetTriggerActionsRequest]): DataOrg = copy(triggerActions = __v)
    ...
    def addSecondFactors(__vs: com.zitadel.management.v1.management.AddSecondFactorToLoginPolicyRequest *): DataOrg = addAllSecondFactors(__vs)
    def addAllSecondFactors(__vs: Iterable[com.zitadel.management.v1.management.AddSecondFactorToLoginPolicyRequest]): DataOrg = copy(secondFactors = secondFactors ++ __vs)
    def withSecondFactors(__v: _root_.scala.Seq[com.zitadel.management.v1.management.AddSecondFactorToLoginPolicyRequest]): DataOrg = copy(secondFactors = __v)
    def clearMultiFactors = copy(multiFactors = _root_.scala.Seq.empty)
    def addMultiFactors(__vs: com.zitadel.management.v1.management.AddMultiFactorToLoginPolicyRequest *): DataOrg = addAllMultiFactors(__vs)
    def addAllMultiFactors(__vs: Iterable[com.zitadel.management.v1.management.AddMultiFactorToLoginPolicyRequest]): DataOrg = copy(multiFactors = multiFactors ++ __vs)
    def withMultiFactors(__v: _root_.scala.Seq[com.zitadel.management.v1.management.AddMultiFactorToLoginPolicyRequest]): DataOrg = copy(multiFactors = __v)
    def clearIdps = copy(idps = _root_.scala.Seq.empty)
    def addIdps(__vs: com.zitadel.management.v1.management.AddIDPToLoginPolicyRequest *): DataOrg = addAllIdps(__vs)
    def addAllIdps(__vs: Iterable[com.zitadel.management.v1.management.AddIDPToLoginPolicyRequest]): DataOrg = copy(idps = idps ++ __vs)
    def withIdps(__v: _root_.scala.Seq[com.zitadel.management.v1.management.AddIDPToLoginPolicyRequest]): DataOrg = copy(idps = __v)
    ...
    def getFieldByNumber(__fieldNumber: _root_.scala.Int): _root_.scala.Any = {
      (__fieldNumber: @_root_.scala.unchecked) match {
        ...
        case 31 => oidcIdps
        case 32 => jwtIdps
        case 33 => secondFactors
        case 34 => multiFactors
        case 35 => idps
        case 36 => userLinks
        case 37 => domains
        case 38 => appKeys
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 4 => iamPolicy.map(_.toPMessage).getOrElse(_root_.scalapb.descriptors.PEmpty)
        ...
        case 33 => _root_.scalapb.descriptors.PRepeated(secondFactors.iterator.map(_.toPMessage).toVector)
        case 34 => _root_.scalapb.descriptors.PRepeated(multiFactors.iterator.map(_.toPMessage).toVector)
        case 35 => _root_.scalapb.descriptors.PRepeated(idps.iterator.map(_.toPMessage).toVector)
        case 36 => _root_.scalapb.descriptors.PRepeated(userLinks.iterator.map(_.toPMessage).toVector)
        case 37 => _root_.scalapb.descriptors.PRepeated(domains.iterator.map(_.toPMessage).toVector)
        case 38 => _root_.scalapb.descriptors.PRepeated(appKeys.iterator.map(_.toPMessage).toVector)
        case 39 => _root_.scalapb.descriptors.PRepeated(machineKeys.iterator.map(_.toPMessage).toVector)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion: com.zitadel.v1.v1.v1.DataOrg.type = com.zitadel.v1.v1.v1.DataOrg
    // @@protoc_insertion_point(GeneratedMessage[zitadel.v1.v1.DataOrg])
}

object DataOrg extends scalapb.GeneratedMessageCompanion[com.zitadel.v1.v1.v1.DataOrg] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.v1.v1.v1.DataOrg] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.v1.v1.v1.DataOrg = {
    ...
    var __iamPolicy: _root_.scala.Option[com.zitadel.v1.v1.v1.AddCustomOrgIAMPolicyRequest] = _root_.scala.None
    ...
    val __triggerActions: _root_.scala.collection.immutable.VectorBuilder[com.zitadel.v1.v1.v1.SetTriggerActionsRequest] = new _root_.scala.collection.immutable.VectorBuilder[com.zitadel.v1.v1.v1.SetTriggerActionsRequest]
    ...
    val __secondFactors: _root_.scala.collection.immutable.VectorBuilder[com.zitadel.management.v1.management.AddSecondFactorToLoginPolicyRequest] = new _root_.scala.collection.immutable.VectorBuilder[com.zitadel.management.v1.management.AddSecondFactorToLoginPolicyRequest]
    val __multiFactors: _root_.scala.collection.immutable.VectorBuilder[com.zitadel.management.v1.management.AddMultiFactorToLoginPolicyRequest] = new _root_.scala.collection.immutable.VectorBuilder[com.zitadel.management.v1.management.AddMultiFactorToLoginPolicyRequest]
    val __idps: _root_.scala.collection.immutable.VectorBuilder[com.zitadel.management.v1.management.AddIDPToLoginPolicyRequest] = new _root_.scala.collection.immutable.VectorBuilder[com.zitadel.management.v1.management.AddIDPToLoginPolicyRequest]
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 34 =>
          __iamPolicy = Option(__iamPolicy.fold(_root_.scalapb.LiteParser.readMessage[com.zitadel.v1.v1.v1.AddCustomOrgIAMPolicyRequest](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
        case 42 =>
        ...
        case 130 =>
          __triggerActions += _root_.scalapb.LiteParser.readMessage[com.zitadel.v1.v1.v1.SetTriggerActionsRequest](_input__)
        case 138 =>
        ...
        case 266 =>
          __secondFactors += _root_.scalapb.LiteParser.readMessage[com.zitadel.management.v1.management.AddSecondFactorToLoginPolicyRequest](_input__)
        case 274 =>
          __multiFactors += _root_.scalapb.LiteParser.readMessage[com.zitadel.management.v1.management.AddMultiFactorToLoginPolicyRequest](_input__)
        case 282 =>
          __idps += _root_.scalapb.LiteParser.readMessage[com.zitadel.management.v1.management.AddIDPToLoginPolicyRequest](_input__)
        case 290 =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.v1.v1.v1.DataOrg] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      com.zitadel.v1.v1.v1.DataOrg(
        ...
        iamPolicy = __fieldsMap.get(scalaDescriptor.findFieldByNumber(4).get).flatMap(_.as[_root_.scala.Option[com.zitadel.v1.v1.v1.AddCustomOrgIAMPolicyRequest]]),
        ...
        triggerActions = __fieldsMap.get(scalaDescriptor.findFieldByNumber(16).get).map(_.as[_root_.scala.Seq[com.zitadel.v1.v1.v1.SetTriggerActionsRequest]]).getOrElse(_root_.scala.Seq.empty),
        ...
        secondFactors = __fieldsMap.get(scalaDescriptor.findFieldByNumber(33).get).map(_.as[_root_.scala.Seq[com.zitadel.management.v1.management.AddSecondFactorToLoginPolicyRequest]]).getOrElse(_root_.scala.Seq.empty),
        multiFactors = __fieldsMap.get(scalaDescriptor.findFieldByNumber(34).get).map(_.as[_root_.scala.Seq[com.zitadel.management.v1.management.AddMultiFactorToLoginPolicyRequest]]).getOrElse(_root_.scala.Seq.empty),
        idps = __fieldsMap.get(scalaDescriptor.findFieldByNumber(35).get).map(_.as[_root_.scala.Seq[com.zitadel.management.v1.management.AddIDPToLoginPolicyRequest]]).getOrElse(_root_.scala.Seq.empty),
        userLinks = __fieldsMap.get(scalaDescriptor.findFieldByNumber(36).get).map(_.as[_root_.scala.Seq[com.zitadel.idp.v1.idp.IDPUserLink]]).getOrElse(_root_.scala.Seq.empty),
        domains = __fieldsMap.get(scalaDescriptor.findFieldByNumber(37).get).map(_.as[_root_.scala.Seq[com.zitadel.org.v1.org.Domain]]).getOrElse(_root_.scala.Seq.empty),
        appKeys = __fieldsMap.get(scalaDescriptor.findFieldByNumber(38).get).map(_.as[_root_.scala.Seq[com.zitadel.v1.v1.v1.DataAppKey]]).getOrElse(_root_.scala.Seq.empty),
        machineKeys = __fieldsMap.get(scalaDescriptor.findFieldByNumber(39).get).map(_.as[_root_.scala.Seq[com.zitadel.v1.v1.v1.DataMachineKey]]).getOrElse(_root_.scala.Seq.empty)
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = V1Proto.javaDescriptor.getMessageTypes().get(2)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = V1Proto.scalaDescriptor.messages(2)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    var __out: _root_.scalapb.GeneratedMessageCompanion[_] = null
    (__number: @_root_.scala.unchecked) match {
      case 3 => __out = com.zitadel.management.v1.management.AddOrgRequest
      case 4 => __out = com.zitadel.v1.v1.v1.AddCustomOrgIAMPolicyRequest
      ...
      case 16 => __out = com.zitadel.v1.v1.v1.SetTriggerActionsRequest
      ...
      case 33 => __out = com.zitadel.management.v1.management.AddSecondFactorToLoginPolicyRequest
      case 34 => __out = com.zitadel.management.v1.management.AddMultiFactorToLoginPolicyRequest
      case 35 => __out = com.zitadel.management.v1.management.AddIDPToLoginPolicyRequest
      case 36 => __out = com.zitadel.idp.v1.idp.IDPUserLink
      case 37 => __out = com.zitadel.org.v1.org.Domain
      case 38 => __out = com.zitadel.v1.v1.v1.DataAppKey
      case 39 => __out = com.zitadel.v1.v1.v1.DataMachineKey
    }
    __out
  }
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = com.zitadel.v1.v1.v1.DataOrg(
    orgId = "",
    org = _root_.scala.None,
    iamPolicy = _root_.scala.None,
  ...
  implicit class DataOrgLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.v1.v1.v1.DataOrg]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.v1.v1.v1.DataOrg](_l) {
    ...
    def iamPolicy: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.v1.v1.v1.AddCustomOrgIAMPolicyRequest] = field(_.getIamPolicy)((c_, f_) => c_.copy(iamPolicy = Option(f_)))
    def optionalIamPolicy: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[com.zitadel.v1.v1.v1.AddCustomOrgIAMPolicyRequest]] = field(_.iamPolicy)((c_, f_) => c_.copy(iamPolicy = f_))
    ...
    def triggerActions: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[com.zitadel.v1.v1.v1.SetTriggerActionsRequest]] = field(_.triggerActions)((c_, f_) => c_.copy(triggerActions = f_))
    ...
    def secondFactors: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[com.zitadel.management.v1.management.AddSecondFactorToLoginPolicyRequest]] = field(_.secondFactors)((c_, f_) => c_.copy(secondFactors = f_))
    def multiFactors: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[com.zitadel.management.v1.management.AddMultiFactorToLoginPolicyRequest]] = field(_.multiFactors)((c_, f_) => c_.copy(multiFactors = f_))
    def idps: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[com.zitadel.management.v1.management.AddIDPToLoginPolicyRequest]] = field(_.idps)((c_, f_) => c_.copy(idps = f_))
  ...
  final val IAM_POLICY_FIELD_NUMBER = 4
  ...
  final val SECOND_FACTORS_FIELD_NUMBER = 33
  final val MULTI_FACTORS_FIELD_NUMBER = 34
  final val IDPS_FIELD_NUMBER = 35
  final val USER_LINKS_FIELD_NUMBER = 36
  final val DOMAINS_FIELD_NUMBER = 37
  final val APP_KEYS_FIELD_NUMBER = 38
  final val MACHINE_KEYS_FIELD_NUMBER = 39
  def of(
    orgId: _root_.scala.Predef.String,
    org: _root_.scala.Option[com.zitadel.management.v1.management.AddOrgRequest],
    iamPolicy: _root_.scala.Option[com.zitadel.v1.v1.v1.AddCustomOrgIAMPolicyRequest],
    ...
    triggerActions: _root_.scala.Seq[com.zitadel.v1.v1.v1.SetTriggerActionsRequest],
    ...
    secondFactors: _root_.scala.Seq[com.zitadel.management.v1.management.AddSecondFactorToLoginPolicyRequest],
    multiFactors: _root_.scala.Seq[com.zitadel.management.v1.management.AddMultiFactorToLoginPolicyRequest],
    idps: _root_.scala.Seq[com.zitadel.management.v1.management.AddIDPToLoginPolicyRequest],
  ...
  ): _root_.com.zitadel.v1.v1.v1.DataOrg = _root_.com.zitadel.v1.v1.v1.DataOrg(
    orgId,
    org,
    iamPolicy,
    labelPolicy,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.v1.v1.DataOrg])
}
