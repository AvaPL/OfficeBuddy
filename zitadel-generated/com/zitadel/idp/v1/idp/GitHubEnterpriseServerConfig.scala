...
@SerialVersionUID(0L)
final case class GitHubEnterpriseServerConfig(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[GitHubEnterpriseServerConfig] {
    @transient
    ...
    def withClientId(__v: _root_.scala.Predef.String): GitHubEnterpriseServerConfig = copy(clientId = __v)
    def withAuthorizationEndpoint(__v: _root_.scala.Predef.String): GitHubEnterpriseServerConfig = copy(authorizationEndpoint = __v)
    def withTokenEndpoint(__v: _root_.scala.Predef.String): GitHubEnterpriseServerConfig = copy(tokenEndpoint = __v)
    def withUserEndpoint(__v: _root_.scala.Predef.String): GitHubEnterpriseServerConfig = copy(userEndpoint = __v)
    def clearScopes = copy(scopes = _root_.scala.Seq.empty)
    def addScopes(__vs: _root_.scala.Predef.String *): GitHubEnterpriseServerConfig = addAllScopes(__vs)
    def addAllScopes(__vs: Iterable[_root_.scala.Predef.String]): GitHubEnterpriseServerConfig = copy(scopes = scopes ++ __vs)
    def withScopes(__v: _root_.scala.Seq[_root_.scala.Predef.String]): GitHubEnterpriseServerConfig = copy(scopes = __v)
    ...
    def companion: com.zitadel.idp.v1.idp.GitHubEnterpriseServerConfig.type = com.zitadel.idp.v1.idp.GitHubEnterpriseServerConfig
    // @@protoc_insertion_point(GeneratedMessage[zitadel.idp.v1.GitHubEnterpriseServerConfig])
}

object GitHubEnterpriseServerConfig extends scalapb.GeneratedMessageCompanion[com.zitadel.idp.v1.idp.GitHubEnterpriseServerConfig] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.idp.v1.idp.GitHubEnterpriseServerConfig] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.idp.v1.idp.GitHubEnterpriseServerConfig = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.idp.v1.idp.GitHubEnterpriseServerConfig] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = IdpProto.javaDescriptor.getMessageTypes().get(13)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = IdpProto.scalaDescriptor.messages(13)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = com.zitadel.idp.v1.idp.GitHubEnterpriseServerConfig(
    clientId = "",
  ...
  implicit class GitHubEnterpriseServerConfigLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.idp.v1.idp.GitHubEnterpriseServerConfig]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.idp.v1.idp.GitHubEnterpriseServerConfig](_l) {
  ...
  ): _root_.com.zitadel.idp.v1.idp.GitHubEnterpriseServerConfig = _root_.com.zitadel.idp.v1.idp.GitHubEnterpriseServerConfig(
    clientId,
    authorizationEndpoint,
    tokenEndpoint,
    userEndpoint,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.idp.v1.GitHubEnterpriseServerConfig])
}
