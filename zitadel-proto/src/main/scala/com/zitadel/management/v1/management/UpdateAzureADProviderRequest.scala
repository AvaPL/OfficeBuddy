...
/** @param clientSecret
  ...
  */
@SerialVersionUID(0L)
final case class UpdateAzureADProviderRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[UpdateAzureADProviderRequest] {
    @transient
    ...
    def withId(__v: _root_.scala.Predef.String): UpdateAzureADProviderRequest = copy(id = __v)
    def withName(__v: _root_.scala.Predef.String): UpdateAzureADProviderRequest = copy(name = __v)
    def withClientId(__v: _root_.scala.Predef.String): UpdateAzureADProviderRequest = copy(clientId = __v)
    def withClientSecret(__v: _root_.scala.Predef.String): UpdateAzureADProviderRequest = copy(clientSecret = __v)
    def getTenant: com.zitadel.idp.v1.idp.AzureADTenant = tenant.getOrElse(com.zitadel.idp.v1.idp.AzureADTenant.defaultInstance)
    def clearTenant: UpdateAzureADProviderRequest = copy(tenant = _root_.scala.None)
    def withTenant(__v: com.zitadel.idp.v1.idp.AzureADTenant): UpdateAzureADProviderRequest = copy(tenant = Option(__v))
    def withEmailVerified(__v: _root_.scala.Boolean): UpdateAzureADProviderRequest = copy(emailVerified = __v)
    def clearScopes = copy(scopes = _root_.scala.Seq.empty)
    def addScopes(__vs: _root_.scala.Predef.String *): UpdateAzureADProviderRequest = addAllScopes(__vs)
    def addAllScopes(__vs: Iterable[_root_.scala.Predef.String]): UpdateAzureADProviderRequest = copy(scopes = scopes ++ __vs)
    def withScopes(__v: _root_.scala.Seq[_root_.scala.Predef.String]): UpdateAzureADProviderRequest = copy(scopes = __v)
    ...
    def clearProviderOptions: UpdateAzureADProviderRequest = copy(providerOptions = _root_.scala.None)
    def withProviderOptions(__v: com.zitadel.idp.v1.idp.Options): UpdateAzureADProviderRequest = copy(providerOptions = Option(__v))
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 5 => tenant.map(_.toPMessage).getOrElse(_root_.scalapb.descriptors.PEmpty)
        case 6 => _root_.scalapb.descriptors.PBoolean(emailVerified)
    ...
    def companion: com.zitadel.management.v1.management.UpdateAzureADProviderRequest.type = com.zitadel.management.v1.management.UpdateAzureADProviderRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.management.v1.UpdateAzureADProviderRequest])
}

object UpdateAzureADProviderRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.UpdateAzureADProviderRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.UpdateAzureADProviderRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.management.v1.management.UpdateAzureADProviderRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.management.v1.management.UpdateAzureADProviderRequest] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      com.zitadel.management.v1.management.UpdateAzureADProviderRequest(
        ...
        tenant = __fieldsMap.get(scalaDescriptor.findFieldByNumber(5).get).flatMap(_.as[_root_.scala.Option[com.zitadel.idp.v1.idp.AzureADTenant]]),
        emailVerified = __fieldsMap.get(scalaDescriptor.findFieldByNumber(6).get).map(_.as[_root_.scala.Boolean]).getOrElse(false),
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ManagementProto.javaDescriptor.getMessageTypes().get(504)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ManagementProto.scalaDescriptor.messages(504)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    var __out: _root_.scalapb.GeneratedMessageCompanion[_] = null
    (__number: @_root_.scala.unchecked) match {
      case 5 => __out = com.zitadel.idp.v1.idp.AzureADTenant
  ...
  lazy val defaultInstance = com.zitadel.management.v1.management.UpdateAzureADProviderRequest(
    id = "",
    name = "",
    clientId = "",
    clientSecret = "",
  ...
  implicit class UpdateAzureADProviderRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.management.v1.management.UpdateAzureADProviderRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.management.v1.management.UpdateAzureADProviderRequest](_l) {
  ...
  final val TENANT_FIELD_NUMBER = 5
  final val EMAIL_VERIFIED_FIELD_NUMBER = 6
  ...
  ): _root_.com.zitadel.management.v1.management.UpdateAzureADProviderRequest = _root_.com.zitadel.management.v1.management.UpdateAzureADProviderRequest(
    id,
    name,
    clientId,
    clientSecret,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.management.v1.UpdateAzureADProviderRequest])
}
