...
@SerialVersionUID(0L)
final case class UpdateCustomLabelPolicyRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[UpdateCustomLabelPolicyRequest] {
    @transient
    ...
    def withPrimaryColor(__v: _root_.scala.Predef.String): UpdateCustomLabelPolicyRequest = copy(primaryColor = __v)
    def withHideLoginNameSuffix(__v: _root_.scala.Boolean): UpdateCustomLabelPolicyRequest = copy(hideLoginNameSuffix = __v)
    def withWarnColor(__v: _root_.scala.Predef.String): UpdateCustomLabelPolicyRequest = copy(warnColor = __v)
    def withBackgroundColor(__v: _root_.scala.Predef.String): UpdateCustomLabelPolicyRequest = copy(backgroundColor = __v)
    def withFontColor(__v: _root_.scala.Predef.String): UpdateCustomLabelPolicyRequest = copy(fontColor = __v)
    def withPrimaryColorDark(__v: _root_.scala.Predef.String): UpdateCustomLabelPolicyRequest = copy(primaryColorDark = __v)
    def withBackgroundColorDark(__v: _root_.scala.Predef.String): UpdateCustomLabelPolicyRequest = copy(backgroundColorDark = __v)
    def withWarnColorDark(__v: _root_.scala.Predef.String): UpdateCustomLabelPolicyRequest = copy(warnColorDark = __v)
    def withFontColorDark(__v: _root_.scala.Predef.String): UpdateCustomLabelPolicyRequest = copy(fontColorDark = __v)
    def withDisableWatermark(__v: _root_.scala.Boolean): UpdateCustomLabelPolicyRequest = copy(disableWatermark = __v)
    ...
    def companion: com.zitadel.management.v1.management.UpdateCustomLabelPolicyRequest.type = com.zitadel.management.v1.management.UpdateCustomLabelPolicyRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.management.v1.UpdateCustomLabelPolicyRequest])
}

object UpdateCustomLabelPolicyRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.UpdateCustomLabelPolicyRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.UpdateCustomLabelPolicyRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.management.v1.management.UpdateCustomLabelPolicyRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.management.v1.management.UpdateCustomLabelPolicyRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ManagementProto.javaDescriptor.getMessageTypes().get(382)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ManagementProto.scalaDescriptor.messages(382)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = com.zitadel.management.v1.management.UpdateCustomLabelPolicyRequest(
    primaryColor = "",
  ...
  implicit class UpdateCustomLabelPolicyRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.management.v1.management.UpdateCustomLabelPolicyRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.management.v1.management.UpdateCustomLabelPolicyRequest](_l) {
  ...
  ): _root_.com.zitadel.management.v1.management.UpdateCustomLabelPolicyRequest = _root_.com.zitadel.management.v1.management.UpdateCustomLabelPolicyRequest(
    primaryColor,
    hideLoginNameSuffix,
    warnColor,
    backgroundColor,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.management.v1.UpdateCustomLabelPolicyRequest])
}
