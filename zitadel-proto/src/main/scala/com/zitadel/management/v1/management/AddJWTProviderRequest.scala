...
@SerialVersionUID(0L)
final case class AddJWTProviderRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[AddJWTProviderRequest] {
    @transient
    ...
    def withName(__v: _root_.scala.Predef.String): AddJWTProviderRequest = copy(name = __v)
    def withIssuer(__v: _root_.scala.Predef.String): AddJWTProviderRequest = copy(issuer = __v)
    def withJwtEndpoint(__v: _root_.scala.Predef.String): AddJWTProviderRequest = copy(jwtEndpoint = __v)
    def withKeysEndpoint(__v: _root_.scala.Predef.String): AddJWTProviderRequest = copy(keysEndpoint = __v)
    def withHeaderName(__v: _root_.scala.Predef.String): AddJWTProviderRequest = copy(headerName = __v)
    ...
    def clearProviderOptions: AddJWTProviderRequest = copy(providerOptions = _root_.scala.None)
    def withProviderOptions(__v: com.zitadel.idp.v1.idp.Options): AddJWTProviderRequest = copy(providerOptions = Option(__v))
    ...
    def companion: com.zitadel.management.v1.management.AddJWTProviderRequest.type = com.zitadel.management.v1.management.AddJWTProviderRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.management.v1.AddJWTProviderRequest])
}

object AddJWTProviderRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.AddJWTProviderRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.AddJWTProviderRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.management.v1.management.AddJWTProviderRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.management.v1.management.AddJWTProviderRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ManagementProto.javaDescriptor.getMessageTypes().get(498)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ManagementProto.scalaDescriptor.messages(498)
  ...
  lazy val defaultInstance = com.zitadel.management.v1.management.AddJWTProviderRequest(
    name = "",
    issuer = "",
    jwtEndpoint = "",
    keysEndpoint = "",
  ...
  implicit class AddJWTProviderRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.management.v1.management.AddJWTProviderRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.management.v1.management.AddJWTProviderRequest](_l) {
  ...
  ): _root_.com.zitadel.management.v1.management.AddJWTProviderRequest = _root_.com.zitadel.management.v1.management.AddJWTProviderRequest(
    name,
    issuer,
    jwtEndpoint,
    keysEndpoint,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.management.v1.AddJWTProviderRequest])
}
