...
/** @param clientSecret
  ...
  */
@SerialVersionUID(0L)
final case class UpdateGitLabProviderRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[UpdateGitLabProviderRequest] {
    @transient
    ...
    def withId(__v: _root_.scala.Predef.String): UpdateGitLabProviderRequest = copy(id = __v)
    def withName(__v: _root_.scala.Predef.String): UpdateGitLabProviderRequest = copy(name = __v)
    def withClientId(__v: _root_.scala.Predef.String): UpdateGitLabProviderRequest = copy(clientId = __v)
    def withClientSecret(__v: _root_.scala.Predef.String): UpdateGitLabProviderRequest = copy(clientSecret = __v)
    def clearScopes = copy(scopes = _root_.scala.Seq.empty)
    def addScopes(__vs: _root_.scala.Predef.String *): UpdateGitLabProviderRequest = addAllScopes(__vs)
    def addAllScopes(__vs: Iterable[_root_.scala.Predef.String]): UpdateGitLabProviderRequest = copy(scopes = scopes ++ __vs)
    def withScopes(__v: _root_.scala.Seq[_root_.scala.Predef.String]): UpdateGitLabProviderRequest = copy(scopes = __v)
    ...
    def clearProviderOptions: UpdateGitLabProviderRequest = copy(providerOptions = _root_.scala.None)
    def withProviderOptions(__v: com.zitadel.idp.v1.idp.Options): UpdateGitLabProviderRequest = copy(providerOptions = Option(__v))
    ...
    def companion: com.zitadel.management.v1.management.UpdateGitLabProviderRequest.type = com.zitadel.management.v1.management.UpdateGitLabProviderRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.management.v1.UpdateGitLabProviderRequest])
}

object UpdateGitLabProviderRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.UpdateGitLabProviderRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.UpdateGitLabProviderRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.management.v1.management.UpdateGitLabProviderRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.management.v1.management.UpdateGitLabProviderRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ManagementProto.javaDescriptor.getMessageTypes().get(516)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ManagementProto.scalaDescriptor.messages(516)
  ...
  lazy val defaultInstance = com.zitadel.management.v1.management.UpdateGitLabProviderRequest(
    id = "",
    name = "",
    clientId = "",
    clientSecret = "",
  ...
  implicit class UpdateGitLabProviderRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.management.v1.management.UpdateGitLabProviderRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.management.v1.management.UpdateGitLabProviderRequest](_l) {
  ...
  ): _root_.com.zitadel.management.v1.management.UpdateGitLabProviderRequest = _root_.com.zitadel.management.v1.management.UpdateGitLabProviderRequest(
    id,
    name,
    clientId,
    clientSecret,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.management.v1.UpdateGitLabProviderRequest])
}
