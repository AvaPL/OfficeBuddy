...
final case class AddGitHubEnterpriseServerProviderRequest(
    ...
    def companion: com.zitadel.management.v1.management.AddGitHubEnterpriseServerProviderRequest.type = com.zitadel.management.v1.management.AddGitHubEnterpriseServerProviderRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.management.v1.AddGitHubEnterpriseServerProviderRequest])
}

object AddGitHubEnterpriseServerProviderRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.AddGitHubEnterpriseServerProviderRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.AddGitHubEnterpriseServerProviderRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.management.v1.management.AddGitHubEnterpriseServerProviderRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.management.v1.management.AddGitHubEnterpriseServerProviderRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ManagementProto.javaDescriptor.getMessageTypes().get(510)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ManagementProto.scalaDescriptor.messages(510)
  ...
  lazy val defaultInstance = com.zitadel.management.v1.management.AddGitHubEnterpriseServerProviderRequest(
    clientId = "",
    name = "",
    clientSecret = "",
  ...
  implicit class AddGitHubEnterpriseServerProviderRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.management.v1.management.AddGitHubEnterpriseServerProviderRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.management.v1.management.AddGitHubEnterpriseServerProviderRequest](_l) {
  ...
  ): _root_.com.zitadel.management.v1.management.AddGitHubEnterpriseServerProviderRequest = _root_.com.zitadel.management.v1.management.AddGitHubEnterpriseServerProviderRequest(
    clientId,
    name,
    clientSecret,
    authorizationEndpoint,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.management.v1.AddGitHubEnterpriseServerProviderRequest])
}
