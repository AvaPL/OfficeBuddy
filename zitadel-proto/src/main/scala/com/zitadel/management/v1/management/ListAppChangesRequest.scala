...
/** @param query
  ...
  */
@SerialVersionUID(0L)
final case class ListAppChangesRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[ListAppChangesRequest] {
    @transient
    ...
    def clearQuery: ListAppChangesRequest = copy(query = _root_.scala.None)
    def withQuery(__v: com.zitadel.change.v1.change.ChangeQuery): ListAppChangesRequest = copy(query = Option(__v))
    def withProjectId(__v: _root_.scala.Predef.String): ListAppChangesRequest = copy(projectId = __v)
    def withAppId(__v: _root_.scala.Predef.String): ListAppChangesRequest = copy(appId = __v)
    ...
    def companion: com.zitadel.management.v1.management.ListAppChangesRequest.type = com.zitadel.management.v1.management.ListAppChangesRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.management.v1.ListAppChangesRequest])
}

object ListAppChangesRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.ListAppChangesRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.ListAppChangesRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.management.v1.management.ListAppChangesRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.management.v1.management.ListAppChangesRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ManagementProto.javaDescriptor.getMessageTypes().get(214)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ManagementProto.scalaDescriptor.messages(214)
  ...
  lazy val defaultInstance = com.zitadel.management.v1.management.ListAppChangesRequest(
    query = _root_.scala.None,
    projectId = "",
    appId = ""
  )
  implicit class ListAppChangesRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.management.v1.management.ListAppChangesRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.management.v1.management.ListAppChangesRequest](_l) {
  ...
  def of(
    ...
    projectId: _root_.scala.Predef.String,
    appId: _root_.scala.Predef.String
  ): _root_.com.zitadel.management.v1.management.ListAppChangesRequest = _root_.com.zitadel.management.v1.management.ListAppChangesRequest(
    query,
    projectId,
    appId
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.management.v1.ListAppChangesRequest])
}
