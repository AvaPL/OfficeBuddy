...
@SerialVersionUID(0L)
final case class SetCustomDomainClaimedMessageTextRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[SetCustomDomainClaimedMessageTextRequest] {
    @transient
    ...
    def withLanguage(__v: _root_.scala.Predef.String): SetCustomDomainClaimedMessageTextRequest = copy(language = __v)
    def withTitle(__v: _root_.scala.Predef.String): SetCustomDomainClaimedMessageTextRequest = copy(title = __v)
    def withPreHeader(__v: _root_.scala.Predef.String): SetCustomDomainClaimedMessageTextRequest = copy(preHeader = __v)
    def withSubject(__v: _root_.scala.Predef.String): SetCustomDomainClaimedMessageTextRequest = copy(subject = __v)
    def withGreeting(__v: _root_.scala.Predef.String): SetCustomDomainClaimedMessageTextRequest = copy(greeting = __v)
    def withText(__v: _root_.scala.Predef.String): SetCustomDomainClaimedMessageTextRequest = copy(text = __v)
    def withButtonText(__v: _root_.scala.Predef.String): SetCustomDomainClaimedMessageTextRequest = copy(buttonText = __v)
    def withFooterText(__v: _root_.scala.Predef.String): SetCustomDomainClaimedMessageTextRequest = copy(footerText = __v)
    ...
    def companion: com.zitadel.management.v1.management.SetCustomDomainClaimedMessageTextRequest.type = com.zitadel.management.v1.management.SetCustomDomainClaimedMessageTextRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.management.v1.SetCustomDomainClaimedMessageTextRequest])
}

object SetCustomDomainClaimedMessageTextRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.SetCustomDomainClaimedMessageTextRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.SetCustomDomainClaimedMessageTextRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.management.v1.management.SetCustomDomainClaimedMessageTextRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.management.v1.management.SetCustomDomainClaimedMessageTextRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ManagementProto.javaDescriptor.getMessageTypes().get(442)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ManagementProto.scalaDescriptor.messages(442)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = com.zitadel.management.v1.management.SetCustomDomainClaimedMessageTextRequest(
    language = "",
    title = "",
    preHeader = "",
    subject = "",
  ...
  implicit class SetCustomDomainClaimedMessageTextRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.management.v1.management.SetCustomDomainClaimedMessageTextRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.management.v1.management.SetCustomDomainClaimedMessageTextRequest](_l) {
  ...
  def of(
    ...
    buttonText: _root_.scala.Predef.String,
    footerText: _root_.scala.Predef.String
  ): _root_.com.zitadel.management.v1.management.SetCustomDomainClaimedMessageTextRequest = _root_.com.zitadel.management.v1.management.SetCustomDomainClaimedMessageTextRequest(
    language,
    title,
    preHeader,
    subject,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.management.v1.SetCustomDomainClaimedMessageTextRequest])
}
