...
@SerialVersionUID(0L)
final case class AddGenericOIDCProviderRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[AddGenericOIDCProviderRequest] {
    @transient
    ...
    def withName(__v: _root_.scala.Predef.String): AddGenericOIDCProviderRequest = copy(name = __v)
    def withIssuer(__v: _root_.scala.Predef.String): AddGenericOIDCProviderRequest = copy(issuer = __v)
    def withClientId(__v: _root_.scala.Predef.String): AddGenericOIDCProviderRequest = copy(clientId = __v)
    def withClientSecret(__v: _root_.scala.Predef.String): AddGenericOIDCProviderRequest = copy(clientSecret = __v)
    def clearScopes = copy(scopes = _root_.scala.Seq.empty)
    def addScopes(__vs: _root_.scala.Predef.String *): AddGenericOIDCProviderRequest = addAllScopes(__vs)
    def addAllScopes(__vs: Iterable[_root_.scala.Predef.String]): AddGenericOIDCProviderRequest = copy(scopes = scopes ++ __vs)
    def withScopes(__v: _root_.scala.Seq[_root_.scala.Predef.String]): AddGenericOIDCProviderRequest = copy(scopes = __v)
    ...
    def clearProviderOptions: AddGenericOIDCProviderRequest = copy(providerOptions = _root_.scala.None)
    def withProviderOptions(__v: com.zitadel.idp.v1.idp.Options): AddGenericOIDCProviderRequest = copy(providerOptions = Option(__v))
    def withIsIdTokenMapping(__v: _root_.scala.Boolean): AddGenericOIDCProviderRequest = copy(isIdTokenMapping = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 7 => _root_.scalapb.descriptors.PBoolean(isIdTokenMapping)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion: com.zitadel.management.v1.management.AddGenericOIDCProviderRequest.type = com.zitadel.management.v1.management.AddGenericOIDCProviderRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.management.v1.AddGenericOIDCProviderRequest])
}

object AddGenericOIDCProviderRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.AddGenericOIDCProviderRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.management.v1.management.AddGenericOIDCProviderRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.management.v1.management.AddGenericOIDCProviderRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.management.v1.management.AddGenericOIDCProviderRequest] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      com.zitadel.management.v1.management.AddGenericOIDCProviderRequest(
        ...
        isIdTokenMapping = __fieldsMap.get(scalaDescriptor.findFieldByNumber(7).get).map(_.as[_root_.scala.Boolean]).getOrElse(false)
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ManagementProto.javaDescriptor.getMessageTypes().get(492)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ManagementProto.scalaDescriptor.messages(492)
  ...
  lazy val defaultInstance = com.zitadel.management.v1.management.AddGenericOIDCProviderRequest(
    name = "",
    issuer = "",
    clientId = "",
    clientSecret = "",
  ...
  implicit class AddGenericOIDCProviderRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.management.v1.management.AddGenericOIDCProviderRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.management.v1.management.AddGenericOIDCProviderRequest](_l) {
  ...
  final val IS_ID_TOKEN_MAPPING_FIELD_NUMBER = 7
  def of(
    name: _root_.scala.Predef.String,
    issuer: _root_.scala.Predef.String,
    clientId: _root_.scala.Predef.String,
  ...
  ): _root_.com.zitadel.management.v1.management.AddGenericOIDCProviderRequest = _root_.com.zitadel.management.v1.management.AddGenericOIDCProviderRequest(
    name,
    issuer,
    clientId,
    clientSecret,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.management.v1.AddGenericOIDCProviderRequest])
}
