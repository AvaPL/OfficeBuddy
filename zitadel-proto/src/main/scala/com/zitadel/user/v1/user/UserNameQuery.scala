...
@SerialVersionUID(0L)
final case class UserNameQuery(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[UserNameQuery] {
    @transient
    ...
    def withUserName(__v: _root_.scala.Predef.String): UserNameQuery = copy(userName = __v)
    def withMethod(__v: com.zitadel.v1.`object`.TextQueryMethod): UserNameQuery = copy(method = __v)
    ...
    def companion: com.zitadel.user.v1.user.UserNameQuery.type = com.zitadel.user.v1.user.UserNameQuery
    // @@protoc_insertion_point(GeneratedMessage[zitadel.user.v1.UserNameQuery])
}

object UserNameQuery extends scalapb.GeneratedMessageCompanion[com.zitadel.user.v1.user.UserNameQuery] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.user.v1.user.UserNameQuery] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.user.v1.user.UserNameQuery = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.user.v1.user.UserNameQuery] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = com.zitadel.user.v1.user.UserNameQuery(
    userName = "",
    method = com.zitadel.v1.`object`.TextQueryMethod.TEXT_QUERY_METHOD_EQUALS
  )
  implicit class UserNameQueryLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.user.v1.user.UserNameQuery]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.user.v1.user.UserNameQuery](_l) {
  ...
  ): _root_.com.zitadel.user.v1.user.UserNameQuery = _root_.com.zitadel.user.v1.user.UserNameQuery(
    userName,
    method
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.user.v1.UserNameQuery])
}
