...
@SerialVersionUID(0L)
final case class PasswordlessRegistrationScreenText(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[PasswordlessRegistrationScreenText] {
    @transient
    ...
    def withTitle(__v: _root_.scala.Predef.String): PasswordlessRegistrationScreenText = copy(title = __v)
    def withDescription(__v: _root_.scala.Predef.String): PasswordlessRegistrationScreenText = copy(description = __v)
    def withTokenNameLabel(__v: _root_.scala.Predef.String): PasswordlessRegistrationScreenText = copy(tokenNameLabel = __v)
    def withNotSupported(__v: _root_.scala.Predef.String): PasswordlessRegistrationScreenText = copy(notSupported = __v)
    def withRegisterTokenButtonText(__v: _root_.scala.Predef.String): PasswordlessRegistrationScreenText = copy(registerTokenButtonText = __v)
    def withErrorRetry(__v: _root_.scala.Predef.String): PasswordlessRegistrationScreenText = copy(errorRetry = __v)
    ...
    def companion: com.zitadel.text.v1.text.PasswordlessRegistrationScreenText.type = com.zitadel.text.v1.text.PasswordlessRegistrationScreenText
    // @@protoc_insertion_point(GeneratedMessage[zitadel.text.v1.PasswordlessRegistrationScreenText])
}

object PasswordlessRegistrationScreenText extends scalapb.GeneratedMessageCompanion[com.zitadel.text.v1.text.PasswordlessRegistrationScreenText] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.text.v1.text.PasswordlessRegistrationScreenText] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.text.v1.text.PasswordlessRegistrationScreenText = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.text.v1.text.PasswordlessRegistrationScreenText] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = TextProto.javaDescriptor.getMessageTypes().get(34)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = TextProto.scalaDescriptor.messages(34)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = com.zitadel.text.v1.text.PasswordlessRegistrationScreenText(
    title = "",
    description = "",
    tokenNameLabel = "",
    notSupported = "",
  ...
  implicit class PasswordlessRegistrationScreenTextLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.text.v1.text.PasswordlessRegistrationScreenText]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.text.v1.text.PasswordlessRegistrationScreenText](_l) {
  ...
  def of(
    ...
    registerTokenButtonText: _root_.scala.Predef.String,
    errorRetry: _root_.scala.Predef.String
  ): _root_.com.zitadel.text.v1.text.PasswordlessRegistrationScreenText = _root_.com.zitadel.text.v1.text.PasswordlessRegistrationScreenText(
    title,
    description,
    tokenNameLabel,
    notSupported,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.text.v1.PasswordlessRegistrationScreenText])
}
