...
final case class UpdateGoogleProviderRequest(
    ...
    def companion: com.zitadel.admin.v1.admin.UpdateGoogleProviderRequest.type = com.zitadel.admin.v1.admin.UpdateGoogleProviderRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.admin.v1.UpdateGoogleProviderRequest])
}

object UpdateGoogleProviderRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.UpdateGoogleProviderRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.UpdateGoogleProviderRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.admin.v1.admin.UpdateGoogleProviderRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.admin.v1.admin.UpdateGoogleProviderRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = AdminProto.javaDescriptor.getMessageTypes().get(134)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = AdminProto.scalaDescriptor.messages(134)
  ...
  lazy val defaultInstance = com.zitadel.admin.v1.admin.UpdateGoogleProviderRequest(
    id = "",
    name = "",
    clientId = "",
    clientSecret = "",
  ...
  implicit class UpdateGoogleProviderRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.admin.v1.admin.UpdateGoogleProviderRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.admin.v1.admin.UpdateGoogleProviderRequest](_l) {
  ...
  ): _root_.com.zitadel.admin.v1.admin.UpdateGoogleProviderRequest = _root_.com.zitadel.admin.v1.admin.UpdateGoogleProviderRequest(
    id,
    name,
    clientId,
    clientSecret,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.admin.v1.UpdateGoogleProviderRequest])
}
