...
@SerialVersionUID(0L)
final case class ListIDPsResponse(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[ListIDPsResponse] {
    @transient
    ...
    def clearDetails: ListIDPsResponse = copy(details = _root_.scala.None)
    def withDetails(__v: com.zitadel.v1.`object`.ListDetails): ListIDPsResponse = copy(details = Option(__v))
    def withSortingColumn(__v: com.zitadel.idp.v1.idp.IDPFieldName): ListIDPsResponse = copy(sortingColumn = __v)
    def clearResult = copy(result = _root_.scala.Seq.empty)
    def addResult(__vs: com.zitadel.idp.v1.idp.IDP *): ListIDPsResponse = addAllResult(__vs)
    def addAllResult(__vs: Iterable[com.zitadel.idp.v1.idp.IDP]): ListIDPsResponse = copy(result = result ++ __vs)
    def withResult(__v: _root_.scala.Seq[com.zitadel.idp.v1.idp.IDP]): ListIDPsResponse = copy(result = __v)
    ...
    def companion: com.zitadel.admin.v1.admin.ListIDPsResponse.type = com.zitadel.admin.v1.admin.ListIDPsResponse
    // @@protoc_insertion_point(GeneratedMessage[zitadel.admin.v1.ListIDPsResponse])
}

object ListIDPsResponse extends scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.ListIDPsResponse] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.ListIDPsResponse] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.admin.v1.admin.ListIDPsResponse = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.admin.v1.admin.ListIDPsResponse] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = AdminProto.javaDescriptor.getMessageTypes().get(76)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = AdminProto.scalaDescriptor.messages(76)
  ...
  lazy val defaultInstance = com.zitadel.admin.v1.admin.ListIDPsResponse(
  ...
  implicit class ListIDPsResponseLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.admin.v1.admin.ListIDPsResponse]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.admin.v1.admin.ListIDPsResponse](_l) {
  ...
  ): _root_.com.zitadel.admin.v1.admin.ListIDPsResponse = _root_.com.zitadel.admin.v1.admin.ListIDPsResponse(
    details,
    sortingColumn,
    result
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.admin.v1.ListIDPsResponse])
}
