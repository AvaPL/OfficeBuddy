...
@SerialVersionUID(0L)
final case class UpdateCustomDomainPolicyRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[UpdateCustomDomainPolicyRequest] {
    @transient
    ...
    def withOrgId(__v: _root_.scala.Predef.String): UpdateCustomDomainPolicyRequest = copy(orgId = __v)
    def withUserLoginMustBeDomain(__v: _root_.scala.Boolean): UpdateCustomDomainPolicyRequest = copy(userLoginMustBeDomain = __v)
    def withValidateOrgDomains(__v: _root_.scala.Boolean): UpdateCustomDomainPolicyRequest = copy(validateOrgDomains = __v)
    def withSmtpSenderAddressMatchesInstanceDomain(__v: _root_.scala.Boolean): UpdateCustomDomainPolicyRequest = copy(smtpSenderAddressMatchesInstanceDomain = __v)
    ...
    def companion: com.zitadel.admin.v1.admin.UpdateCustomDomainPolicyRequest.type = com.zitadel.admin.v1.admin.UpdateCustomDomainPolicyRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.admin.v1.UpdateCustomDomainPolicyRequest])
}

object UpdateCustomDomainPolicyRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.UpdateCustomDomainPolicyRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.UpdateCustomDomainPolicyRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.admin.v1.admin.UpdateCustomDomainPolicyRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.admin.v1.admin.UpdateCustomDomainPolicyRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = AdminProto.javaDescriptor.getMessageTypes().get(162)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = AdminProto.scalaDescriptor.messages(162)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = com.zitadel.admin.v1.admin.UpdateCustomDomainPolicyRequest(
    orgId = "",
    userLoginMustBeDomain = false,
    validateOrgDomains = false,
    smtpSenderAddressMatchesInstanceDomain = false
  )
  implicit class UpdateCustomDomainPolicyRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.admin.v1.admin.UpdateCustomDomainPolicyRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.admin.v1.admin.UpdateCustomDomainPolicyRequest](_l) {
  ...
  ): _root_.com.zitadel.admin.v1.admin.UpdateCustomDomainPolicyRequest = _root_.com.zitadel.admin.v1.admin.UpdateCustomDomainPolicyRequest(
    orgId,
    userLoginMustBeDomain,
    validateOrgDomains,
    smtpSenderAddressMatchesInstanceDomain
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.admin.v1.UpdateCustomDomainPolicyRequest])
}
