...
@SerialVersionUID(0L)
final case class UpdateIDPJWTConfigRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[UpdateIDPJWTConfigRequest] {
    @transient
    ...
    def withIdpId(__v: _root_.scala.Predef.String): UpdateIDPJWTConfigRequest = copy(idpId = __v)
    def withJwtEndpoint(__v: _root_.scala.Predef.String): UpdateIDPJWTConfigRequest = copy(jwtEndpoint = __v)
    def withIssuer(__v: _root_.scala.Predef.String): UpdateIDPJWTConfigRequest = copy(issuer = __v)
    def withKeysEndpoint(__v: _root_.scala.Predef.String): UpdateIDPJWTConfigRequest = copy(keysEndpoint = __v)
    def withHeaderName(__v: _root_.scala.Predef.String): UpdateIDPJWTConfigRequest = copy(headerName = __v)
    ...
    def companion: com.zitadel.admin.v1.admin.UpdateIDPJWTConfigRequest.type = com.zitadel.admin.v1.admin.UpdateIDPJWTConfigRequest
    // @@protoc_insertion_point(GeneratedMessage[zitadel.admin.v1.UpdateIDPJWTConfigRequest])
}

object UpdateIDPJWTConfigRequest extends scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.UpdateIDPJWTConfigRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.UpdateIDPJWTConfigRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.admin.v1.admin.UpdateIDPJWTConfigRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.admin.v1.admin.UpdateIDPJWTConfigRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = AdminProto.javaDescriptor.getMessageTypes().get(91)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = AdminProto.scalaDescriptor.messages(91)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = com.zitadel.admin.v1.admin.UpdateIDPJWTConfigRequest(
    idpId = "",
    jwtEndpoint = "",
    issuer = "",
    keysEndpoint = "",
  ...
  implicit class UpdateIDPJWTConfigRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.admin.v1.admin.UpdateIDPJWTConfigRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.admin.v1.admin.UpdateIDPJWTConfigRequest](_l) {
  ...
  def of(
    ...
    keysEndpoint: _root_.scala.Predef.String,
    headerName: _root_.scala.Predef.String
  ): _root_.com.zitadel.admin.v1.admin.UpdateIDPJWTConfigRequest = _root_.com.zitadel.admin.v1.admin.UpdateIDPJWTConfigRequest(
    idpId,
    jwtEndpoint,
    issuer,
    keysEndpoint,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.admin.v1.UpdateIDPJWTConfigRequest])
}
