...
final case class ListProvidersResponse(
    ...
    def companion: com.zitadel.admin.v1.admin.ListProvidersResponse.type = com.zitadel.admin.v1.admin.ListProvidersResponse
    // @@protoc_insertion_point(GeneratedMessage[zitadel.admin.v1.ListProvidersResponse])
}

object ListProvidersResponse extends scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.ListProvidersResponse] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.admin.v1.admin.ListProvidersResponse] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.admin.v1.admin.ListProvidersResponse = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.admin.v1.admin.ListProvidersResponse] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = AdminProto.javaDescriptor.getMessageTypes().get(95)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = AdminProto.scalaDescriptor.messages(95)
  ...
  lazy val defaultInstance = com.zitadel.admin.v1.admin.ListProvidersResponse(
    details = _root_.scala.None,
    result = _root_.scala.Seq.empty
  )
  implicit class ListProvidersResponseLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.admin.v1.admin.ListProvidersResponse]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.admin.v1.admin.ListProvidersResponse](_l) {
  ...
  ): _root_.com.zitadel.admin.v1.admin.ListProvidersResponse = _root_.com.zitadel.admin.v1.admin.ListProvidersResponse(
    details,
    result
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.admin.v1.ListProvidersResponse])
}
