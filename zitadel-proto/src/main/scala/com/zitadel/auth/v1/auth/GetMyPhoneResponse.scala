...
@SerialVersionUID(0L)
final case class GetMyPhoneResponse(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[GetMyPhoneResponse] {
    @transient
    ...
    def clearDetails: GetMyPhoneResponse = copy(details = _root_.scala.None)
    def withDetails(__v: com.zitadel.v1.`object`.ObjectDetails): GetMyPhoneResponse = copy(details = Option(__v))
    def getPhone: com.zitadel.user.v1.user.Phone = phone.getOrElse(com.zitadel.user.v1.user.Phone.defaultInstance)
    def clearPhone: GetMyPhoneResponse = copy(phone = _root_.scala.None)
    def withPhone(__v: com.zitadel.user.v1.user.Phone): GetMyPhoneResponse = copy(phone = Option(__v))
    ...
    def companion: com.zitadel.auth.v1.auth.GetMyPhoneResponse.type = com.zitadel.auth.v1.auth.GetMyPhoneResponse
    // @@protoc_insertion_point(GeneratedMessage[zitadel.auth.v1.GetMyPhoneResponse])
}

object GetMyPhoneResponse extends scalapb.GeneratedMessageCompanion[com.zitadel.auth.v1.auth.GetMyPhoneResponse] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.auth.v1.auth.GetMyPhoneResponse] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.auth.v1.auth.GetMyPhoneResponse = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.auth.v1.auth.GetMyPhoneResponse] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = AuthProto.javaDescriptor.getMessageTypes().get(49)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = AuthProto.scalaDescriptor.messages(49)
  ...
  lazy val defaultInstance = com.zitadel.auth.v1.auth.GetMyPhoneResponse(
    details = _root_.scala.None,
    phone = _root_.scala.None
  )
  implicit class GetMyPhoneResponseLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.auth.v1.auth.GetMyPhoneResponse]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.auth.v1.auth.GetMyPhoneResponse](_l) {
  ...
  ): _root_.com.zitadel.auth.v1.auth.GetMyPhoneResponse = _root_.com.zitadel.auth.v1.auth.GetMyPhoneResponse(
    details,
    phone
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.auth.v1.GetMyPhoneResponse])
}
