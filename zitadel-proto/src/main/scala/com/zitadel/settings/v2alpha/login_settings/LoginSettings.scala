...
/** @param allowDomainDiscovery
  ...
  */
@SerialVersionUID(0L)
final case class LoginSettings(
    ...
    passkeysType: com.zitadel.settings.v2alpha.login_settings.PasskeysType = com.zitadel.settings.v2alpha.login_settings.PasskeysType.PASSKEYS_TYPE_NOT_ALLOWED,
    ...
    secondFactors: _root_.scala.Seq[com.zitadel.settings.v2alpha.login_settings.SecondFactorType] = _root_.scala.Seq.empty,
    multiFactors: _root_.scala.Seq[com.zitadel.settings.v2alpha.login_settings.MultiFactorType] = _root_.scala.Seq.empty,
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[LoginSettings] {
    ...
    private[this] def __computeSerializedSize(): _root_.scala.Int = {
      ...
      {
        val __value = passkeysType.value
        if (__value != 0) {
    ...
    def writeTo(`_output__`: _root_.com.google.protobuf.CodedOutputStream): _root_.scala.Unit = {
      ...
      if (secondFactors.nonEmpty) {
        ...
        secondFactors.foreach((_output__.writeEnumNoTag _).compose((_: com.zitadel.settings.v2alpha.login_settings.SecondFactorType).value))
      };
      if (multiFactors.nonEmpty) {
        _output__.writeTag(15, 2)
        _output__.writeUInt32NoTag(multiFactorsSerializedSize)
        multiFactors.foreach((_output__.writeEnumNoTag _).compose((_: com.zitadel.settings.v2alpha.login_settings.MultiFactorType).value))
      };
      {
    ...
    def withAllowUsernamePassword(__v: _root_.scala.Boolean): LoginSettings = copy(allowUsernamePassword = __v)
    def withAllowRegister(__v: _root_.scala.Boolean): LoginSettings = copy(allowRegister = __v)
    def withAllowExternalIdp(__v: _root_.scala.Boolean): LoginSettings = copy(allowExternalIdp = __v)
    def withForceMfa(__v: _root_.scala.Boolean): LoginSettings = copy(forceMfa = __v)
    def withPasskeysType(__v: com.zitadel.settings.v2alpha.login_settings.PasskeysType): LoginSettings = copy(passkeysType = __v)
    def withHidePasswordReset(__v: _root_.scala.Boolean): LoginSettings = copy(hidePasswordReset = __v)
    def withIgnoreUnknownUsernames(__v: _root_.scala.Boolean): LoginSettings = copy(ignoreUnknownUsernames = __v)
    def withDefaultRedirectUri(__v: _root_.scala.Predef.String): LoginSettings = copy(defaultRedirectUri = __v)
    ...
    def clearPasswordCheckLifetime: LoginSettings = copy(passwordCheckLifetime = _root_.scala.None)
    def withPasswordCheckLifetime(__v: com.google.protobuf.duration.Duration): LoginSettings = copy(passwordCheckLifetime = Option(__v))
    ...
    def clearExternalLoginCheckLifetime: LoginSettings = copy(externalLoginCheckLifetime = _root_.scala.None)
    def withExternalLoginCheckLifetime(__v: com.google.protobuf.duration.Duration): LoginSettings = copy(externalLoginCheckLifetime = Option(__v))
    ...
    def clearMfaInitSkipLifetime: LoginSettings = copy(mfaInitSkipLifetime = _root_.scala.None)
    def withMfaInitSkipLifetime(__v: com.google.protobuf.duration.Duration): LoginSettings = copy(mfaInitSkipLifetime = Option(__v))
    ...
    def clearSecondFactorCheckLifetime: LoginSettings = copy(secondFactorCheckLifetime = _root_.scala.None)
    def withSecondFactorCheckLifetime(__v: com.google.protobuf.duration.Duration): LoginSettings = copy(secondFactorCheckLifetime = Option(__v))
    ...
    def clearMultiFactorCheckLifetime: LoginSettings = copy(multiFactorCheckLifetime = _root_.scala.None)
    def withMultiFactorCheckLifetime(__v: com.google.protobuf.duration.Duration): LoginSettings = copy(multiFactorCheckLifetime = Option(__v))
    def clearSecondFactors = copy(secondFactors = _root_.scala.Seq.empty)
    def addSecondFactors(__vs: com.zitadel.settings.v2alpha.login_settings.SecondFactorType *): LoginSettings = addAllSecondFactors(__vs)
    def addAllSecondFactors(__vs: Iterable[com.zitadel.settings.v2alpha.login_settings.SecondFactorType]): LoginSettings = copy(secondFactors = secondFactors ++ __vs)
    def withSecondFactors(__v: _root_.scala.Seq[com.zitadel.settings.v2alpha.login_settings.SecondFactorType]): LoginSettings = copy(secondFactors = __v)
    def clearMultiFactors = copy(multiFactors = _root_.scala.Seq.empty)
    def addMultiFactors(__vs: com.zitadel.settings.v2alpha.login_settings.MultiFactorType *): LoginSettings = addAllMultiFactors(__vs)
    def addAllMultiFactors(__vs: Iterable[com.zitadel.settings.v2alpha.login_settings.MultiFactorType]): LoginSettings = copy(multiFactors = multiFactors ++ __vs)
    def withMultiFactors(__v: _root_.scala.Seq[com.zitadel.settings.v2alpha.login_settings.MultiFactorType]): LoginSettings = copy(multiFactors = __v)
    def withAllowDomainDiscovery(__v: _root_.scala.Boolean): LoginSettings = copy(allowDomainDiscovery = __v)
    def withDisableLoginWithEmail(__v: _root_.scala.Boolean): LoginSettings = copy(disableLoginWithEmail = __v)
    def withDisableLoginWithPhone(__v: _root_.scala.Boolean): LoginSettings = copy(disableLoginWithPhone = __v)
    def withResourceOwnerType(__v: com.zitadel.settings.v2alpha.settings.ResourceOwnerType): LoginSettings = copy(resourceOwnerType = __v)
    def withForceMfaLocalOnly(__v: _root_.scala.Boolean): LoginSettings = copy(forceMfaLocalOnly = __v)
    ...
    def getFieldByNumber(__fieldNumber: _root_.scala.Int): _root_.scala.Any = {
      (__fieldNumber: @_root_.scala.unchecked) match {
        ...
        case 5 => {
          val __t = passkeysType.javaValueDescriptor
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 5 => _root_.scalapb.descriptors.PEnum(passkeysType.scalaValueDescriptor)
        ...
        case 16 => _root_.scalapb.descriptors.PBoolean(allowDomainDiscovery)
        case 17 => _root_.scalapb.descriptors.PBoolean(disableLoginWithEmail)
        case 18 => _root_.scalapb.descriptors.PBoolean(disableLoginWithPhone)
        case 19 => _root_.scalapb.descriptors.PEnum(resourceOwnerType.scalaValueDescriptor)
        case 22 => _root_.scalapb.descriptors.PBoolean(forceMfaLocalOnly)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion: com.zitadel.settings.v2alpha.login_settings.LoginSettings.type = com.zitadel.settings.v2alpha.login_settings.LoginSettings
    // @@protoc_insertion_point(GeneratedMessage[zitadel.settings.v2alpha.LoginSettings])
}

object LoginSettings extends scalapb.GeneratedMessageCompanion[com.zitadel.settings.v2alpha.login_settings.LoginSettings] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zitadel.settings.v2alpha.login_settings.LoginSettings] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.zitadel.settings.v2alpha.login_settings.LoginSettings = {
    ...
    var __passkeysType: com.zitadel.settings.v2alpha.login_settings.PasskeysType = com.zitadel.settings.v2alpha.login_settings.PasskeysType.PASSKEYS_TYPE_NOT_ALLOWED
    ...
    val __secondFactors: _root_.scala.collection.immutable.VectorBuilder[com.zitadel.settings.v2alpha.login_settings.SecondFactorType] = new _root_.scala.collection.immutable.VectorBuilder[com.zitadel.settings.v2alpha.login_settings.SecondFactorType]
    val __multiFactors: _root_.scala.collection.immutable.VectorBuilder[com.zitadel.settings.v2alpha.login_settings.MultiFactorType] = new _root_.scala.collection.immutable.VectorBuilder[com.zitadel.settings.v2alpha.login_settings.MultiFactorType]
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 40 =>
          __passkeysType = com.zitadel.settings.v2alpha.login_settings.PasskeysType.fromValue(_input__.readEnum())
        case 48 =>
        ...
        case 112 =>
          __secondFactors += com.zitadel.settings.v2alpha.login_settings.SecondFactorType.fromValue(_input__.readEnum())
        case 114 => {
        ...
        case 120 =>
          __multiFactors += com.zitadel.settings.v2alpha.login_settings.MultiFactorType.fromValue(_input__.readEnum())
        case 122 => {
          val length = _input__.readRawVarint32()
          val oldLimit = _input__.pushLimit(length)
          while (_input__.getBytesUntilLimit > 0) {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zitadel.settings.v2alpha.login_settings.LoginSettings] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      com.zitadel.settings.v2alpha.login_settings.LoginSettings(
        ...
        passkeysType = com.zitadel.settings.v2alpha.login_settings.PasskeysType.fromValue(__fieldsMap.get(scalaDescriptor.findFieldByNumber(5).get).map(_.as[_root_.scalapb.descriptors.EnumValueDescriptor]).getOrElse(com.zitadel.settings.v2alpha.login_settings.PasskeysType.PASSKEYS_TYPE_NOT_ALLOWED.scalaValueDescriptor).number),
        ...
        secondFactors = __fieldsMap.get(scalaDescriptor.findFieldByNumber(14).get).map(_.as[_root_.scala.Seq[_root_.scalapb.descriptors.EnumValueDescriptor]]).getOrElse(_root_.scala.Seq.empty).iterator.map(__e => com.zitadel.settings.v2alpha.login_settings.SecondFactorType.fromValue(__e.number)).toSeq,
        multiFactors = __fieldsMap.get(scalaDescriptor.findFieldByNumber(15).get).map(_.as[_root_.scala.Seq[_root_.scalapb.descriptors.EnumValueDescriptor]]).getOrElse(_root_.scala.Seq.empty).iterator.map(__e => com.zitadel.settings.v2alpha.login_settings.MultiFactorType.fromValue(__e.number)).toSeq,
        allowDomainDiscovery = __fieldsMap.get(scalaDescriptor.findFieldByNumber(16).get).map(_.as[_root_.scala.Boolean]).getOrElse(false),
        disableLoginWithEmail = __fieldsMap.get(scalaDescriptor.findFieldByNumber(17).get).map(_.as[_root_.scala.Boolean]).getOrElse(false),
        disableLoginWithPhone = __fieldsMap.get(scalaDescriptor.findFieldByNumber(18).get).map(_.as[_root_.scala.Boolean]).getOrElse(false),
        resourceOwnerType = com.zitadel.settings.v2alpha.settings.ResourceOwnerType.fromValue(__fieldsMap.get(scalaDescriptor.findFieldByNumber(19).get).map(_.as[_root_.scalapb.descriptors.EnumValueDescriptor]).getOrElse(com.zitadel.settings.v2alpha.settings.ResourceOwnerType.RESOURCE_OWNER_TYPE_UNSPECIFIED.scalaValueDescriptor).number),
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = LoginSettingsProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = LoginSettingsProto.scalaDescriptor.messages(0)
  ...
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = {
    (__fieldNumber: @_root_.scala.unchecked) match {
      case 5 => com.zitadel.settings.v2alpha.login_settings.PasskeysType
      case 14 => com.zitadel.settings.v2alpha.login_settings.SecondFactorType
      case 15 => com.zitadel.settings.v2alpha.login_settings.MultiFactorType
      case 19 => com.zitadel.settings.v2alpha.settings.ResourceOwnerType
    }
  }
  lazy val defaultInstance = com.zitadel.settings.v2alpha.login_settings.LoginSettings(
    allowUsernamePassword = false,
    allowRegister = false,
    allowExternalIdp = false,
    forceMfa = false,
    passkeysType = com.zitadel.settings.v2alpha.login_settings.PasskeysType.PASSKEYS_TYPE_NOT_ALLOWED,
  ...
  implicit class LoginSettingsLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.settings.v2alpha.login_settings.LoginSettings]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zitadel.settings.v2alpha.login_settings.LoginSettings](_l) {
    ...
    def passkeysType: _root_.scalapb.lenses.Lens[UpperPB, com.zitadel.settings.v2alpha.login_settings.PasskeysType] = field(_.passkeysType)((c_, f_) => c_.copy(passkeysType = f_))
    ...
    def secondFactors: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[com.zitadel.settings.v2alpha.login_settings.SecondFactorType]] = field(_.secondFactors)((c_, f_) => c_.copy(secondFactors = f_))
    def multiFactors: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[com.zitadel.settings.v2alpha.login_settings.MultiFactorType]] = field(_.multiFactors)((c_, f_) => c_.copy(multiFactors = f_))
  ...
  final val PASSKEYS_TYPE_FIELD_NUMBER = 5
  ...
  final val ALLOW_DOMAIN_DISCOVERY_FIELD_NUMBER = 16
  final val DISABLE_LOGIN_WITH_EMAIL_FIELD_NUMBER = 17
  final val DISABLE_LOGIN_WITH_PHONE_FIELD_NUMBER = 18
  final val RESOURCE_OWNER_TYPE_FIELD_NUMBER = 19
  ...
  def of(
    ...
    secondFactors: _root_.scala.Seq[com.zitadel.settings.v2alpha.login_settings.SecondFactorType],
    multiFactors: _root_.scala.Seq[com.zitadel.settings.v2alpha.login_settings.MultiFactorType],
  ...
  ): _root_.com.zitadel.settings.v2alpha.login_settings.LoginSettings = _root_.com.zitadel.settings.v2alpha.login_settings.LoginSettings(
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[zitadel.settings.v2alpha.LoginSettings])
}
